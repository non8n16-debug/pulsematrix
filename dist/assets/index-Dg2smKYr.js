...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Gn,depthTest:!1,depthWrite:!1})}function Ac(){return new Pe({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:gl(),fragmentShader:`
		...
		`,blending:Gn,depthTest:!1,depthWrite:!1})}function wc(){return new Pe({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:gl(),fragmentShader:`
	...
	`}function D_(r){let t=new WeakMap,e=null;function n(o){if(o&&o.isTexture){const l=o.mapping,c=l===oo||l===lo,u=l===ur||l===hr;if(c||u){let h=t.get(o);const f=h!==void 0?h.texture.pmremVersion:0;if(o.isRenderTargetTexture&&o.pmremVersion!==f)return e===null&&(e=new Tc(r)),h=c?e.fromEquirectangular(o,h):e.fromCubemap(o,h),h.texture.pmremVersion=o.pmremVersion,t.set(o,h),h.texture;if(h!==void 0)return h.texture;{const p=o.image;return c&&p&&p.height>0||u&&p&&i(p)?(e===null&&(e=new Tc(r)),h=c?e.fromEquirectangular(o):e.fromCubemap(o),h.texture.pmremVersion=o.pmremVersion,t.set(o,h),o.addEventListener("dispose",s),h.texture):null}}}return o}function i(o){let l=0;const c=6;for(let u=0;u<c;u++)o[u]!==void 0&&l++;return l===c}function s(o){const l=o.target;l.removeEventListener("dispose",s);const c=t.get(l);c!==void 0&&(t.delete(l),c.dispose())}function a(){t=new WeakMap,e!==null&&(e.dispose(),e=null)}return{get:n,dispose:a}}function L_(r){const t={};function e(n){if(t[n]!==void 0)return t[n];let i;switch(n){case"WEBGL_depth_texture":i=r.getExtension("WEBGL_depth_texture")||r.getExtension("MOZ_WEBGL_depth_texture")||r.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":i=r.getExtension("EXT_texture_filter_anisotropic")||r.getExtension("MOZ_EXT_texture_filter_anisotropic")||r.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":i=r.getExtension("WEBGL_compressed_texture_s3tc")||r.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||r.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":i=r.getExtension("WEBGL_compressed_texture_pvrtc")||r.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:i=r.getExtension(n)}return t[n]=i,i}return{has:function(n){return e(n)!==null},init:function(){e("EXT_color_buffer_float"),e("WEBGL_clip_cull_distance"),e("OES_texture_float_linear"),e("EXT_color_buffer_half_float"),e("WEBGL_multisampled_render_to_texture"),e("WEBGL_render_shared_exponent")},get:function(n){const i=e(n);return i===null&&Xr("THREE.WebGLRenderer: "+n+" extension not supported."),i}}}function U_(r,t,e,n){const i={},s=new WeakMap;function a(h){const f=h.target;f.index!==null&&t.remove(f.index);for(const g in f.attributes)t.remove(f.attributes[g]);f.removeEventListener("dispose",a),delete i[f.id];const p=s.get(f);p&&(t.remove(p),s.delete(f)),n.releaseStatesOfGeometry(f),f.isInstancedBufferGeometry===!0&&delete f._maxInstanceCount,e.memory.geometries--}function o(h,f){return i[f.id]===!0||(f.addEventListener("dispose",a),i[f.id]=!0,e.memory.geometries++),f}function l(h){const f=h.attributes;for(const p in f)t.update(f[p],r.ARRAY_BUFFER)}function c(h){const f=[],p=h.index,g=h.attributes.position;let _=0;if(p!==null){const T=p.array;_=p.version;for(let E=0,M=T.length;E<M;E+=3){const b=T[E+0],A=T[E+1],w=T[E+2];f.push(b,A,A,w,w,b)}}else if(g!==void 0){const T=g.array;_=g.version;for(let E=0,M=T.length/3-1;E<M;E+=3){const b=E+0,A=E+1,w=E+2;f.push(b,A,A,w,w,b)}}else return;const m=new(bu(f)?Pu:Cu)(f,1);m.version=_;const d=s.get(h);d&&t.remove(d),s.set(h,m)}function u(h){const f=s.get(h);if(f){const p=h.index;p!==null&&f.version<p.version&&c(h)}else c(h);return s.get(h)}return{get:o,update:l,getWireframeAttribute:u}}function I_(r,t,e){let n;function i(f){n=f}let s,a;function o(f){s=f.type,a=f.bytesPerElement}function l(f,p){r.drawElements(n,p,s,f*a),e.update(p,n,1)}function c(f,p,g){g!==0&&(r.drawElementsInstanced(n,p,s,f*a,g),e.update(p,n,g))}function u(f,p,g){if(g===0)return;t.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,p,0,s,f,0,g);let m=0;for(let d=0;d<g;d++)m+=p[d];e.update(m,n,1)}function h(f,p,g,_){if(g===0)return;const m=t.get("WEBGL_multi_draw");if(m===null)for(let d=0;d<f.length;d++)c(f[d]/a,p[d],_[d]);else{m.multiDrawElementsInstancedWEBGL(n,p,0,s,f,0,_,0,g);let d=0;for(let T=0;T<g;T++)d+=p[T]*_[T];e.update(d,n,1)}}this.setMode=i,this.setIndex=o,this.render=l,this.renderInstances=c,this.renderMultiDraw=u,this.renderMultiDrawInstances=h}function F_(r){const t={geometries:0,textures:0},e={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,a,o){switch(e.calls++,a){case r.TRIANGLES:e.triangles+=o*(s/3);break;case r.LINES:e.lines+=o*(s/2);break;case r.LINE_STRIP:e.lines+=o*(s-1);break;case r.LINE_LOOP:e.lines+=o*s;break;case r.POINTS:e.points+=o*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",a);break}}function i(){e.calls=0,e.triangles=0,e.points=0,e.lines=0}return{memory:t,render:e,programs:null,autoReset:!0,reset:i,update:n}}function N_(r,t,e){const n=new WeakMap,i=new jt;function s(a,o,l){const c=a.morphTargetInfluences,u=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,h=u!==void 0?u.length:0;let f=n.get(o);if(f===void 0||f.count!==h){let y=function(){C.dispose(),n.delete(o),o.removeEventListener("dispose",y)};var p=y;f!==void 0&&f.texture.dispose();const g=o.morphAttributes.position!==void 0,_=o.morphAttributes.normal!==void 0,m=o.morphAttributes.color!==void 0,d=o.morphAttributes.position||[],T=o.morphAttributes.normal||[],E=o.morphAttributes.color||[];let M=0;g===!0&&(M=1),_===!0&&(M=2),m===!0&&(M=3);let b=o.attributes.position.count*M,A=1;b>t.maxTextureSize&&(A=Math.ceil(b/t.maxTextureSize),b=t.maxTextureSize);const w=new Float32Array(b*A*4*h),C=new Au(w,b,A,h);C.type=Hn,C.needsUpdate=!0;const x=M*4;for(let D=0;D<h;D++){const N=d[D],B=T[D],X=E[D],H=b*A*4*D;for(let G=0;G<N.count;G++){const Y=G*x;g===!0&&(i.fromBufferAttribute(N,G),w[H+Y+0]=i.x,w[H+Y+1]=i.y,w[H+Y+2]=i.z,w[H+Y+3]=0),_===!0&&(i.fromBufferAttribute(B,G),w[H+Y+4]=i.x,w[H+Y+5]=i.y,w[H+Y+6]=i.z,w[H+Y+7]=0),m===!0&&(i.fromBufferAttribute(X,G),w[H+Y+8]=i.x,w[H+Y+9]=i.y,w[H+Y+10]=i.z,w[H+Y+11]=X.itemSize===4?i.w:1)}}f={count:h,texture:C,size:new Lt(b,A)},n.set(o,f),o.addEventListener("dispose",y)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)l.getUniforms().setValue(r,"morphTexture",a.morphTexture,e);else{let g=0;for(let m=0;m<c.length;m++)g+=c[m];const _=o.morphTargetsRelative?1:1-g;l.getUniforms().setValue(r,"morphTargetBaseInfluence",_),l.getUniforms().setValue(r,"morphTargetInfluences",c)}l.getUniforms().setValue(r,"morphTargetsTexture",f.texture,e),l.getUniforms().setValue(r,"morphTargetsTextureSize",f.size)}return{update:s}}function O_(r,t,e,n){let i=new WeakMap;function s(l){const c=n.render.frame,u=l.geometry,h=t.get(l,u);if(i.get(h)!==c&&(t.update(h),i.set(h,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",o)===!1&&l.addEventListener("dispose",o),i.get(l)!==c&&(e.update(l.instanceMatrix,r.ARRAY_BUFFER),l.instanceColor!==null&&e.update(l.instanceColor,r.ARRAY_BUFFER),i.set(l,c))),l.isSkinnedMesh){const f=l.skeleton;i.get(f)!==c&&(f.update(),i.set(f,c))}return h}function a(){i=new WeakMap}function o(l){const c=l.target;c.removeEventListener("dispose",o),e.remove(c.instanceMatrix),c.instanceColor!==null&&e.remove(c.instanceColor)}return{update:s,dispose:a}}const Vu=new ke,Rc=new Fu(1,1),Hu=new Au,Gu=new ld,Wu=new Uu,Cc=[],Pc=[],Dc=new Float32Array(16),Lc=new Float32Array(9),Uc=new Float32Array(4);function Er(r,t,e){const n=r[0];if(n<=0||n>0)return r;const i=t*e;let s=Cc[i];if(s===void 0&&(s=new Float32Array(i),Cc[i]=s),t!==0){n.toArray(s,0);for(let a=1,o=0;a!==t;++a)o+=e,r[a].toArray(s,o)}return s}function xe(r,t){if(r.length!==t.length)return!1;for(let e=0,n=r.length;e<n;e++)if(r[e]!==t[e])return!1;return!0}function Me(r,t){for(let e=0,n=t.length;e<n;e++)r[e]=t[e]}function ra(r,t){let e=Pc[t];e===void 0&&(e=new Int32Array(t),Pc[t]=e);for(let n=0;n!==t;++n)e[n]=r.allocateTextureUnit();return e}function B_(r,t){const e=this.cache;e[0]!==t&&(r.uniform1f(this.addr,t),e[0]=t)}function z_(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(r.uniform2f(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(xe(e,t))return;r.uniform2fv(this.addr,t),Me(e,t)}}function k_(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(r.uniform3f(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else if(t.r!==void 0)(e[0]!==t.r||e[1]!==t.g||e[2]!==t.b)&&(r.uniform3f(this.addr,t.r,t.g,t.b),e[0]=t.r,e[1]=t.g,e[2]=t.b);else{if(xe(e,t))return;r.uniform3fv(this.addr,t),Me(e,t)}}function V_(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(r.uniform4f(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(xe(e,t))return;r.uniform4fv(this.addr,t),Me(e,t)}}function H_(r,t){const e=this.cache,n=t.elements;if(n===void 0){if(xe(e,t))return;r.uniformMatrix2fv(this.addr,!1,t),Me(e,t)}else{if(xe(e,n))return;Uc.set(n),r.uniformMatrix2fv(this.addr,!1,Uc),Me(e,n)}}function G_(r,t){const e=this.cache,n=t.elements;if(n===void 0){if(xe(e,t))return;r.uniformMatrix3fv(this.addr,!1,t),Me(e,t)}else{if(xe(e,n))return;Lc.set(n),r.uniformMatrix3fv(this.addr,!1,Lc),Me(e,n)}}function W_(r,t){const e=this.cache,n=t.elements;if(n===void 0){if(xe(e,t))return;r.uniformMatrix4fv(this.addr,!1,t),Me(e,t)}else{if(xe(e,n))return;Dc.set(n),r.uniformMatrix4fv(this.addr,!1,Dc),Me(e,n)}}function X_(r,t){const e=this.cache;e[0]!==t&&(r.uniform1i(this.addr,t),e[0]=t)}function q_(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(r.uniform2i(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(xe(e,t))return;r.uniform2iv(this.addr,t),Me(e,t)}}function Y_(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(r.uniform3i(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(xe(e,t))return;r.uniform3iv(this.addr,t),Me(e,t)}}function K_(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(r.uniform4i(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(xe(e,t))return;r.uniform4iv(this.addr,t),Me(e,t)}}function $_(r,t){const e=this.cache;e[0]!==t&&(r.uniform1ui(this.addr,t),e[0]=t)}function Z_(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(r.uniform2ui(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(xe(e,t))return;r.uniform2uiv(this.addr,t),Me(e,t)}}function j_(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(r.uniform3ui(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(xe(e,t))return;r.uniform3uiv(this.addr,t),Me(e,t)}}function J_(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(r.uniform4ui(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(xe(e,t))return;r.uniform4uiv(this.addr,t),Me(e,t)}}function Q_(r,t,e){const n=this.cache,i=e.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i);let s;this.type===r.SAMPLER_2D_SHADOW?(Rc.compareFunction=Tu,s=Rc):s=Vu,e.setTexture2D(t||s,i)}function tg(r,t,e){const n=this.cache,i=e.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i),e.setTexture3D(t||Gu,i)}function eg(r,t,e){const n=this.cache,i=e.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i),e.setTextureCube(t||Wu,i)}function ng(r,t,e){const n=this.cache,i=e.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i),e.setTexture2DArray(t||Hu,i)}function ig(r){switch(r){case 5126:return B_;case 35664:return z_;case 35665:return k_;case 35666:return V_;case 35674:return H_;case 35675:return G_;case 35676:return W_;case 5124:case 35670:return X_;case 35667:case 35671:return q_;case 35668:case 35672:return Y_;case 35669:case 35673:return K_;case 5125:return $_;case 36294:return Z_;case 36295:return j_;case 36296:return J_;case 35678:case 36198:case 36298:case 36306:case 35682:return Q_;case 35679:case 36299:case 36307:return tg;case 35680:case 36300:case 36308:case 36293:return eg;case 36289:case 36303:case 36311:case 36292:return ng}}function rg(r,t){r.uniform1fv(this.addr,t)}function sg(r,t){const e=Er(t,this.size,2);r.uniform2fv(this.addr,e)}function ag(r,t){const e=Er(t,this.size,3);r.uniform3fv(this.addr,e)}function og(r,t){const e=Er(t,this.size,4);r.uniform4fv(this.addr,e)}function lg(r,t){const e=Er(t,this.size,4);r.uniformMatrix2fv(this.addr,!1,e)}function cg(r,t){const e=Er(t,this.size,9);r.uniformMatrix3fv(this.addr,!1,e)}function ug(r,t){const e=Er(t,this.size,16);r.uniformMatrix4fv(this.addr,!1,e)}function hg(r,t){r.uniform1iv(this.addr,t)}function fg(r,t){r.uniform2iv(this.addr,t)}function dg(r,t){r.uniform3iv(this.addr,t)}function pg(r,t){r.uniform4iv(this.addr,t)}function mg(r,t){r.uniform1uiv(this.addr,t)}function _g(r,t){r.uniform2uiv(this.addr,t)}function gg(r,t){r.uniform3uiv(this.addr,t)}function vg(r,t){r.uniform4uiv(this.addr,t)}function xg(r,t,e){const n=this.cache,i=t.length,s=ra(e,i);xe(n,s)||(r.uniform1iv(this.addr,s),Me(n,s));for(let a=0;a!==i;++a)e.setTexture2D(t[a]||Vu,s[a])}function Mg(r,t,e){const n=this.cache,i=t.length,s=ra(e,i);xe(n,s)||(r.uniform1iv(this.addr,s),Me(n,s));for(let a=0;a!==i;++a)e.setTexture3D(t[a]||Gu,s[a])}function Sg(r,t,e){const n=this.cache,i=t.length,s=ra(e,i);xe(n,s)||(r.uniform1iv(this.addr,s),Me(n,s));for(let a=0;a!==i;++a)e.setTextureCube(t[a]||Wu,s[a])}function yg(r,t,e){const n=this.cache,i=t.length,s=ra(e,i);xe(n,s)||(r.uniform1iv(this.addr,s),Me(n,s));for(let a=0;a!==i;++a)e.setTexture2DArray(t[a]||Hu,s[a])}function Eg(r){switch(r){case 5126:return rg;case 35664:return sg;case 35665:return ag;case 35666:return og;case 35674:return lg;case 35675:return cg;case 35676:return ug;case 5124:case 35670:return hg;case 35667:case 35671:return fg;case 35668:case 35672:return dg;case 35669:case 35673:return pg;case 5125:return mg;case 36294:return _g;case 36295:return gg;case 36296:return vg;case 35678:case 36198:case 36298:case 36306:case 35682:return xg;case 35679:case 36299:case 36307:return Mg;case 35680:case 36300:case 36308:case 36293:return Sg;case 36289:case 36303:case 36311:case 36292:return yg}}class Tg{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.setValue=ig(e.type)}}class bg{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.size=e.size,this.setValue=Eg(e.type)}}class Ag{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,e,n){const i=this.seq;for(let s=0,a=i.length;s!==a;++s){const o=i[s];o.setValue(t,e[o.id],n)}}}const Va=/(\w+)(\])?(\[|\.)?/g;function Ic(r,t){r.seq.push(t),r.map[t.id]=t}function wg(r,t,e){const n=r.name,i=n.length;for(Va.lastIndex=0;;){const s=Va.exec(n),a=Va.lastIndex;let o=s[1];const l=s[2]==="]",c=s[3];if(l&&(o=o|0),c===void 0||c==="["&&a+2===i){Ic(e,c===void 0?new Tg(o,r,t):new bg(o,r,t));break}else{let h=e.map[o];h===void 0&&(h=new Ag(o),Ic(e,h)),e=h}}}class Bs{constructor(t,e){this.seq=[],this.map={};const n=t.getProgramParameter(e,t.ACTIVE_UNIFORMS);for(let i=0;i<n;++i){const s=t.getActiveUniform(e,i),a=t.getUniformLocation(e,s.name);wg(s,a,this)}}setValue(t,e,n,i){const s=this.map[e];s!==void 0&&s.setValue(t,n,i)}setOptional(t,e,n){const i=e[n];i!==void 0&&this.setValue(t,n,i)}static upload(t,e,n,i){for(let s=0,a=e.length;s!==a;++s){const o=e[s],l=n[o.id];l.needsUpdate!==!1&&o.setValue(t,l.value,i)}}static seqWithValue(t,e){const n=[];for(let i=0,s=t.length;i!==s;++i){const a=t[i];a.id in e&&n.push(a)}return n}}function Fc(r,t,e){const n=r.createShader(t);return r.shaderSource(n,e),r.compileShader(n),n}const Rg=37297;let Cg=0;function Pg(r,t){const e=r.split(`
`),n=[],i=Math.max(t-6,0),s=Math.min(t+6,e.length);for(let a=i;a<s;a++){const o=a+1;n.push(`${o===t?">":" "} ${o}: ${e[a]}`)}return n.join(`
`)}const Nc=new Nt;function Dg(r){qt._getMatrix(Nc,qt.workingColorSpace,r);const t=`mat3( ${Nc.elements.map(e=>e.toFixed(4))} )`;switch(qt.getTransfer(r)){case Gs:return[t,"LinearTransferOETF"];case Zt:return[t,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",r),[t,"LinearTransferOETF"]}}function Oc(r,t,e){const n=r.getShaderParameter(t,r.COMPILE_STATUS),s=(r.getShaderInfoLog(t)||"").trim();if(n&&s==="")return"";const a=/ERROR: 0:(\d+)/.exec(s);if(a){const o=parseInt(a[1]);return e.toUpperCase()+`

`+s+`

`+Pg(r.getShaderSource(t),o)}else return s}function Lg(r,t){const e=Dg(t);return[`vec4 ${r}( vec4 value ) {`,`	return ${e[1]}( vec4( value.rgb * ${e[0]}, value.a ) );`,"}"].join(`
`)}function Ug(r,t){let e;switch(t){case Sf:e="Linear";break;case yf:e="Reinhard";break;case Ef:e="Cineon";break;case Tf:e="ACESFilmic";break;case Af:e="AgX";break;case wf:e="Neutral";break;case bf:e="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",t),e="Linear"}return"vec3 "+r+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}const Ls=new F;function Ig(){qt.getLuminanceCoefficients(Ls);const r=Ls.x.toFixed(4),t=Ls.y.toFixed(4),e=Ls.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${r}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
`)}function Fg(r){return[r.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",r.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Lr).join(`
`)}function Ng(r){const t=[];for(const e in r){const n=r[e];n!==!1&&t.push("#define "+e+" "+n)}return t.join(`
`)}function Og(r,t){const e={},n=r.getProgramParameter(t,r.ACTIVE_ATTRIBUTES);for(let i=0;i<n;i++){const s=r.getActiveAttrib(t,i),a=s.name;let o=1;s.type===r.FLOAT_MAT2&&(o=2),s.type===r.FLOAT_MAT3&&(o=3),s.type===r.FLOAT_MAT4&&(o=4),e[a]={type:s.type,location:r.getAttribLocation(t,a),locationSize:o}}return e}function Lr(r){return r!==""}function Bc(r,t){const e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return r.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function zc(r,t){return r.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const Bg=/^[ \t]*#include +<([\w\d./]+)>/gm;function Vo(r){return r.replace(Bg,kg)}const zg=new Map;function kg(r,t){let e=Bt[t];if(e===void 0){const n=zg.get(t);if(n!==void 0)e=Bt[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,n);else throw new Error("Can not resolve #include <"+t+">")}return Vo(e)}const Vg=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function kc(r){return r.replace(Vg,Hg)}function Hg(r,t,e,n){let i="";for(let s=parseInt(t);s<parseInt(e);s++)i+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return i}function Vc(r){let t=`precision ${r.precision} float;
...
#define LOW_PRECISION`),t}function Gg(r){let t="SHADOWMAP_TYPE_BASIC";return r.shadowMapType===fu?t="SHADOWMAP_TYPE_PCF":r.shadowMapType===Qh?t="SHADOWMAP_TYPE_PCF_SOFT":r.shadowMapType===Bn&&(t="SHADOWMAP_TYPE_VSM"),t}function Wg(r){let t="ENVMAP_TYPE_CUBE";if(r.envMap)switch(r.envMapMode){case ur:case hr:t="ENVMAP_TYPE_CUBE";break;case na:t="ENVMAP_TYPE_CUBE_UV";break}return t}function Xg(r){let t="ENVMAP_MODE_REFLECTION";if(r.envMap)switch(r.envMapMode){case hr:t="ENVMAP_MODE_REFRACTION";break}return t}function qg(r){let t="ENVMAP_BLENDING_NONE";if(r.envMap)switch(r.combine){case du:t="ENVMAP_BLENDING_MULTIPLY";break;case xf:t="ENVMAP_BLENDING_MIX";break;case Mf:t="ENVMAP_BLENDING_ADD";break}return t}function Yg(r){const t=r.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),112)),texelHeight:n,maxMip:e}}function Kg(r,t,e,n){const i=r.getContext(),s=e.defines;let a=e.vertexShader,o=e.fragmentShader;const l=Gg(e),c=Wg(e),u=Xg(e),h=qg(e),f=Yg(e),p=Fg(e),g=Ng(s),_=i.createProgram();let m,d,T=e.glslVersion?"#version "+e.glslVersion+`
...
*/var tn={autoSleep:120,force3D:"auto",nullTargetWarn:1,units:{lineHeight:""}},pr={duration:.5,overwrite:!1,delay:0},vl,be,se,un=1e8,te=1/un,Ho=Math.PI*2,E0=Ho/4,T0=0,qu=Math.sqrt,b0=Math.cos,A0=Math.sin,Ee=function(t){return typeof t=="string"},de=function(t){return typeof t=="function"},qn=function(t){return typeof t=="number"},xl=function(t){return typeof t>"u"},Dn=function(t){return typeof t=="object"},Ve=function(t){return t!==!1},Ml=function(){return typeof window<"u"},Us=function(t){return de(t)||Ee(t)},Yu=typeof ArrayBuffer=="function"&&ArrayBuffer.isView||function(){},Le=Array.isArray,Go=/(?:-?\.?\d|\.)+/gi,Ku=/[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g,nr=/[-+=.]*\d+[.e-]*\d*[a-z%]*/g,Ha=/[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi,$u=/[+-]=-?[.\d]+/,Zu=/[^,'"\[\]\s]+/gi,w0=/^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i,ue,yn,Wo,Sl,nn={},$s={},ju,Ju=function(t){return($s=mr(t,nn))&&Xe},yl=function(t,e){return console.warn("Invalid property",t,"set to",e,"Missing plugin? gsap.registerPlugin()")},qr=function(t,e){return!e&&console.warn(t)},Qu=function(t,e){return t&&(nn[t]=e)&&$s&&($s[t]=e)||nn},Yr=function(){return 0},R0={suppressEvents:!0,isStart:!0,kill:!1},zs={suppressEvents:!0,kill:!1},C0={suppressEvents:!0},El={},si=[],Xo={},th,Ze={},Ga={},Xc=30,ks=[],Tl="",bl=function(t){var e=t[0],n,i;if(Dn(e)||de(e)||(t=[t]),!(n=(e._gsap||{}).harness)){for(i=ks.length;i--&&!ks[i].targetTest(e););n=ks[i]}for(i=t.length;i--;)t[i]&&(t[i]._gsap||(t[i]._gsap=new Th(t[i],n)))||t.splice(i,1);return t},Pi=function(t){return t._gsap||bl(hn(t))[0]._gsap},eh=function(t,e,n){return(n=t[e])&&de(n)?t[e]():xl(n)&&t.getAttribute&&t.getAttribute(e)||n},He=function(t,e){return(t=t.split(",")).forEach(e)||t},me=function(t){return Math.round(t*1e5)/1e5||0},ve=function(t){return Math.round(t*1e7)/1e7||0},ar=function(t,e){var n=e.charAt(0),i=parseFloat(e.substr(2));return t=parseFloat(t),n==="+"?t+i:n==="-"?t-i:n==="*"?t*i:t/i},P0=function(t,e){for(var n=e.length,i=0;t.indexOf(e[i])<0&&++i<n;);return i<n},Zs=function(){var t=si.length,e=si.slice(0),n,i;for(Xo={},si.length=0,n=0;n<t;n++)i=e[n],i&&i._lazy&&(i.render(i._lazy[0],i._lazy[1],!0)._lazy=0)},Al=function(t){return!!(t._initted||t._startAt||t.add)},nh=function(t,e,n,i){si.length&&!be&&Zs(),t.render(e,n,!!(be&&e<0&&Al(t))),si.length&&!be&&Zs()},ih=function(t){var e=parseFloat(t);return(e||e===0)&&(t+"").match(Zu).length<2?e:Ee(t)?t.trim():t},rh=function(t){return t},rn=function(t,e){for(var n in e)n in t||(t[n]=e[n]);return t},D0=function(t){return function(e,n){for(var i in n)i in e||i==="duration"&&t||i==="ease"||(e[i]=n[i])}},mr=function(t,e){for(var n in e)t[n]=e[n];return t},qc=function r(t,e){for(var n in e)n!=="__proto__"&&n!=="constructor"&&n!=="prototype"&&(t[n]=Dn(e[n])?r(t[n]||(t[n]={}),e[n]):e[n]);return t},js=function(t,e){var n={},i;for(i in t)i in e||(n[i]=t[i]);return n},Or=function(t){var e=t.parent||ue,n=t.keyframes?D0(Le(t.keyframes)):rn;if(Ve(t.inherit))for(;e;)n(t,e.vars.defaults),e=e.parent||e._dp;return t},L0=function(t,e){for(var n=t.length,i=n===e.length;i&&n--&&t[n]===e[n];);return n<0},sh=function(t,e,n,i,s){var a=t[i],o;if(s)for(o=e[s];a&&a[s]>o;)a=a._prev;return a?(e._next=a._next,a._next=e):(e._next=t[n],t[n]=e),e._next?e._next._prev=e:t[i]=e,e._prev=a,e.parent=e._dp=t,e},sa=function(t,e,n,i){n===void 0&&(n="_first"),i===void 0&&(i="_last");var s=e._prev,a=e._next;s?s._next=a:t[n]===e&&(t[n]=a),a?a._prev=s:t[i]===e&&(t[i]=s),e._next=e._prev=e.parent=null},li=function(t,e){t.parent&&(!e||t.parent.autoRemoveChildren)&&t.parent.remove&&t.parent.remove(t),t._act=0},Di=function(t,e){if(t&&(!e||e._end>t._dur||e._start<0))for(var n=t;n;)n._dirty=1,n=n.parent;return t},U0=function(t){for(var e=t.parent;e&&e.parent;)e._dirty=1,e.totalDuration(),e=e.parent;return t},qo=function(t,e,n,i){return t._startAt&&(be?t._startAt.revert(zs):t.vars.immediateRender&&!t.vars.autoRevert||t._startAt.render(e,!0,i))},I0=function r(t){return!t||t._ts&&r(t.parent)},Yc=function(t){return t._repeat?_r(t._tTime,t=t.duration()+t._rDelay)*t:0},_r=function(t,e){var n=Math.floor(t=ve(t/e));return t&&n===t?n-1:n},Js=function(t,e){return(t-e._start)*e._ts+(e._ts>=0?0:e._dirty?e.totalDuration():e._tDur)},aa=function(t){return t._end=ve(t._start+(t._tDur/Math.abs(t._ts||t._rts||te)||0))},oa=function(t,e){var n=t._dp;return n&&n.smoothChildTiming&&t._ts&&(t._start=ve(n._time-(t._ts>0?e/t._ts:((t._dirty?t.totalDuration():t._tDur)-e)/-t._ts)),aa(t),n._dirty||Di(n,t)),t},ah=function(t,e){var n;if((e._time||!e._dur&&e._initted||e._start<t._time&&(e._dur||!e.add))&&(n=Js(t.rawTime(),e),(!e._dur||is(0,e.totalDuration(),n)-e._tTime>te)&&e.render(n,!0)),Di(t,e)._dp&&t._initted&&t._time>=t._dur&&t._ts){if(t._dur<t.duration())for(n=t;n._dp;)n.rawTime()>=0&&n.totalTime(n._tTime),n=n._dp;t._zTime=-te}},Tn=function(t,e,n,i){return e.parent&&li(e),e._start=ve((qn(n)?n:n||t!==ue?ln(t,n,e):t._time)+e._delay),e._end=ve(e._start+(e.totalDuration()/Math.abs(e.timeScale())||0)),sh(t,e,"_first","_last",t._sort?"_start":0),Yo(e)||(t._recent=e),i||ah(t,e),t._ts<0&&oa(t,t._tTime),t},oh=function(t,e){return(nn.ScrollTrigger||yl("scrollTrigger",e))&&nn.ScrollTrigger.create(e,t)},lh=function(t,e,n,i,s){if(Rl(t,e,s),!t._initted)return 1;if(!n&&t._pt&&!be&&(t._dur&&t.vars.lazy!==!1||!t._dur&&t.vars.lazy)&&th!==Je.frame)return si.push(t),t._lazy=[s,i],1},F0=function r(t){var e=t.parent;return e&&e._ts&&e._initted&&!e._lock&&(e.rawTime()<0||r(e))},Yo=function(t){var e=t.data;return e==="isFromStart"||e==="isStart"},N0=function(t,e,n,i){var s=t.ratio,a=e<0||!e&&(!t._start&&F0(t)&&!(!t._initted&&Yo(t))||(t._ts<0||t._dp._ts<0)&&!Yo(t))?0:1,o=t._rDelay,l=0,c,u,h;if(o&&t._repeat&&(l=is(0,t._tDur,e),u=_r(l,o),t._yoyo&&u&1&&(a=1-a),u!==_r(t._tTime,o)&&(s=1-a,t.vars.repeatRefresh&&t._initted&&t.invalidate())),a!==s||be||i||t._zTime===te||!e&&t._zTime){if(!t._initted&&lh(t,e,i,n,l))return;for(h=t._zTime,t._zTime=e||(n?te:0),n||(n=e&&!h),t.ratio=a,t._from&&(a=1-a),t._time=0,t._tTime=l,c=t._pt;c;)c.r(a,c.d),c=c._next;e<0&&qo(t,e,n,!0),t._onUpdate&&!n&&Qe(t,"onUpdate"),l&&t._repeat&&!n&&t.parent&&Qe(t,"onRepeat"),(e>=t._tDur||e<0)&&t.ratio===a&&(a&&li(t,1),!n&&!be&&(Qe(t,a?"onComplete":"onReverseComplete",!0),t._prom&&t._prom()))}else t._zTime||(t._zTime=e)},O0=function(t,e,n){var i;if(n>e)for(i=t._first;i&&i._start<=n;){if(i.data==="isPause"&&i._start>e)return i;i=i._next}else for(i=t._last;i&&i._start>=n;){if(i.data==="isPause"&&i._start<e)return i;i=i._prev}},gr=function(t,e,n,i){var s=t._repeat,a=ve(e)||0,o=t._tTime/t._tDur;return o&&!i&&(t._time*=a/t._dur),t._dur=a,t._tDur=s?s<0?1e10:ve(a*(s+1)+t._rDelay*s):a,o>0&&!i&&oa(t,t._tTime=t._tDur*o),t.parent&&aa(t),n||Di(t.parent,t),t},Kc=function(t){return t instanceof Ne?Di(t):gr(t,t._dur)},B0={_start:0,endTime:Yr,totalDuration:Yr},ln=function r(t,e,n){var i=t.labels,s=t._recent||B0,a=t.duration()>=un?s.endTime(!1):t._dur,o,l,c;return Ee(e)&&(isNaN(e)||e in i)?(l=e.charAt(0),c=e.substr(-1)==="%",o=e.indexOf("="),l==="<"||l===">"?(o>=0&&(e=e.replace(/=/,"")),(l==="<"?s._start:s.endTime(s._repeat>=0))+(parseFloat(e.substr(1))||0)*(c?(o<0?s:n).totalDuration()/100:1)):o<0?(e in i||(i[e]=a),i[e]):(l=parseFloat(e.charAt(o-1)+e.substr(o+1)),c&&n&&(l=l/100*(Le(n)?n[0]:n).totalDuration()),o>1?r(t,e.substr(0,o-1),n)+l:a+l)):e==null?a:+e},Br=function(t,e,n){var i=qn(e[1]),s=(i?2:1)+(t<2?0:1),a=e[s],o,l;if(i&&(a.duration=e[1]),a.parent=n,t){for(o=a,l=n;l&&!("immediateRender"in o);)o=l.vars.defaults||{},l=Ve(l.vars.inherit)&&l.parent;a.immediateRender=Ve(o.immediateRender),t<2?a.runBackwards=1:a.startAt=e[s-1]}return new ge(e[0],a,e[s+1])},ui=function(t,e){return t||t===0?e(t):e},is=function(t,e,n){return n<t?t:n>e?e:n},Ce=function(t,e){return!Ee(t)||!(e=w0.exec(t))?"":e[1]},z0=function(t,e,n){return ui(n,function(i){return is(t,e,i)})},Ko=[].slice,ch=function(t,e){return t&&Dn(t)&&"length"in t&&(!e&&!t.length||t.length-1 in t&&Dn(t[0]))&&!t.nodeType&&t!==yn},k0=function(t,e,n){return n===void 0&&(n=[]),t.forEach(function(i){var s;return Ee(i)&&!e||ch(i,1)?(s=n).push.apply(s,hn(i)):n.push(i)})||n},hn=function(t,e,n){return se&&!e&&se.selector?se.selector(t):Ee(t)&&!n&&(Wo||!vr())?Ko.call((e||Sl).querySelectorAll(t),0):Le(t)?k0(t,n):ch(t)?Ko.call(t,0):t?[t]:[]},$o=function(t){return t=hn(t)[0]||qr("Invalid scope")||{},function(e){var n=t.current||t.nativeElement||t;return hn(e,n.querySelectorAll?n:n===t?qr("Invalid scope")||Sl.createElement("div"):t)}},uh=function(t){return t.sort(function(){return .5-Math.random()})},hh=function(t){if(de(t))return t;var e=Dn(t)?t:{each:t},n=Li(e.ease),i=e.from||0,s=parseFloat(e.base)||0,a={},o=i>0&&i<1,l=isNaN(i)||o,c=e.axis,u=i,h=i;return Ee(i)?u=h={center:.5,edges:.5,end:1}[i]||0:!o&&l&&(u=i[0],h=i[1]),function(f,p,g){var _=(g||e).length,m=a[_],d,T,E,M,b,A,w,C,x;if(!m){if(x=e.grid==="auto"?0:(e.grid||[1,un])[1],!x){for(w=-un;w<(w=g[x++].getBoundingClientRect().left)&&x<_;);x<_&&x--}for(m=a[_]=[],d=l?Math.min(x,_)*u-.5:i%x,T=x===un?0:l?_*h/x-.5:i/x|0,w=0,C=un,A=0;A<_;A++)E=A%x-d,M=T-(A/x|0),m[A]=b=c?Math.abs(c==="y"?M:E):qu(E*E+M*M),b>w&&(w=b),b<C&&(C=b);i==="random"&&uh(m),m.max=w-C,m.min=C,m.v=_=(parseFloat(e.amount)||parseFloat(e.each)*(x>_?_-1:c?c==="y"?_/x:x:Math.max(x,_/x))||0)*(i==="edges"?-1:1),m.b=_<0?s-_:s,m.u=Ce(e.amount||e.each)||0,n=n&&_<0?Sh(n):n}return _=(m[f]-m.min)/m.max||0,ve(m.b+(n?n(_):_)*m.v)+m.u}},Zo=function(t){var e=Math.pow(10,((t+"").split(".")[1]||"").length);return function(n){var i=ve(Math.round(parseFloat(n)/t)*t*e);return(i-i%1)/e+(qn(n)?0:Ce(n))}},fh=function(t,e){var n=Le(t),i,s;return!n&&Dn(t)&&(i=n=t.radius||un,t.values?(t=hn(t.values),(s=!qn(t[0]))&&(i*=i)):t=Zo(t.increment)),ui(e,n?de(t)?function(a){return s=t(a),Math.abs(s-a)<=i?s:a}:function(a){for(var o=parseFloat(s?a.x:a),l=parseFloat(s?a.y:0),c=un,u=0,h=t.length,f,p;h--;)s?(f=t[h].x-o,p=t[h].y-l,f=f*f+p*p):f=Math.abs(t[h]-o),f<c&&(c=f,u=h);return u=!i||c<=i?t[u]:a,s||u===a||qn(a)?u:u+Ce(a)}:Zo(t))},dh=function(t,e,n,i){return ui(Le(t)?!e:n===!0?!!(n=0):!i,function(){return Le(t)?t[~~(Math.random()*t.length)]:(n=n||1e-5)&&(i=n<1?Math.pow(10,(n+"").length-2):1)&&Math.floor(Math.round((t-n/2+Math.random()*(e-t+n*.99))/n)*n*i)/i})},V0=function(){for(var t=arguments.length,e=new Array(t),n=0;n<t;n++)e[n]=arguments[n];return function(i){return e.reduce(function(s,a){return a(s)},i)}},H0=function(t,e){return function(n){return t(parseFloat(n))+(e||Ce(n))}},G0=function(t,e,n){return mh(t,e,0,1,n)},ph=function(t,e,n){return ui(n,function(i){return t[~~e(i)]})},W0=function r(t,e,n){var i=e-t;return Le(t)?ph(t,r(0,t.length),e):ui(n,function(s){return(i+(s-t)%i)%i+t})},X0=function r(t,e,n){var i=e-t,s=i*2;return Le(t)?ph(t,r(0,t.length-1),e):ui(n,function(a){return a=(s+(a-t)%s)%s||0,t+(a>i?s-a:a)})},Kr=function(t){for(var e=0,n="",i,s,a,o;~(i=t.indexOf("random(",e));)a=t.indexOf(")",i),o=t.charAt(i+7)==="[",s=t.substr(i+7,a-i-7).match(o?Zu:Go),n+=t.substr(e,i-e)+dh(o?s:+s[0],o?0:+s[1],+s[2]||1e-5),e=a+1;return n+t.substr(e,t.length-e)},mh=function(t,e,n,i,s){var a=e-t,o=i-n;return ui(s,function(l){return n+((l-t)/a*o||0)})},q0=function r(t,e,n,i){var s=isNaN(t+e)?0:function(p){return(1-p)*t+p*e};if(!s){var a=Ee(t),o={},l,c,u,h,f;if(n===!0&&(i=1)&&(n=null),a)t={p:t},e={p:e};else if(Le(t)&&!Le(e)){for(u=[],h=t.length,f=h-2,c=1;c<h;c++)u.push(r(t[c-1],t[c]));h--,s=function(g){g*=h;var _=Math.min(f,~~g);return u[_](g-_)},n=e}else i||(t=mr(Le(t)?[]:{},t));if(!u){for(l in e)wl.call(o,t,l,"get",e[l]);s=function(g){return Dl(g,o)||(a?t.p:t)}}}return ui(n,s)},$c=function(t,e,n){var i=t.labels,s=un,a,o,l;for(a in i)o=i[a]-e,o<0==!!n&&o&&s>(o=Math.abs(o))&&(l=a,s=o);return l},Qe=function(t,e,n){var i=t.vars,s=i[e],a=se,o=t._ctx,l,c,u;if(s)return l=i[e+"Params"],c=i.callbackScope||t,n&&si.length&&Zs(),o&&(se=o),u=l?s.apply(c,l):s.call(c),se=a,u},Ur=function(t){return li(t),t.scrollTrigger&&t.scrollTrigger.kill(!!be),t.progress()<1&&Qe(t,"onInterrupt"),t},ir,_h=[],gh=function(t){if(t)if(t=!t.name&&t.default||t,Ml()||t.headless){var e=t.name,n=de(t),i=e&&!n&&t.init?function(){this._props=[]}:t,s={init:Yr,render:Dl,add:wl,kill:lv,modifier:ov,rawVars:0},a={targetTest:0,get:0,getSetter:Pl,aliases:{},register:0};if(vr(),t!==i){if(Ze[e])return;rn(i,rn(js(t,s),a)),mr(i.prototype,mr(s,js(t,a))),Ze[i.prop=e]=i,t.targetTest&&(ks.push(i),El[e]=1),e=(e==="css"?"CSS":e.charAt(0).toUpperCase()+e.substr(1))+"Plugin"}Qu(e,i),t.register&&t.register(Xe,i,Ge)}else _h.push(t)},Qt=255,Ir={aqua:[0,Qt,Qt],lime:[0,Qt,0],silver:[192,192,192],black:[0,0,0],maroon:[128,0,0],teal:[0,128,128],blue:[0,0,Qt],navy:[0,0,128],white:[Qt,Qt,Qt],olive:[128,128,0],yellow:[Qt,Qt,0],orange:[Qt,165,0],gray:[128,128,128],purple:[128,0,128],green:[0,128,0],red:[Qt,0,0],pink:[Qt,192,203],cyan:[0,Qt,Qt],transparent:[Qt,Qt,Qt,0]},Wa=function(t,e,n){return t+=t<0?1:t>1?-1:0,(t*6<1?e+(n-e)*t*6:t<.5?n:t*3<2?e+(n-e)*(2/3-t)*6:e)*Qt+.5|0},vh=function(t,e,n){var i=t?qn(t)?[t>>16,t>>8&Qt,t&Qt]:0:Ir.black,s,a,o,l,c,u,h,f,p,g;if(!i){if(t.substr(-1)===","&&(t=t.substr(0,t.length-1)),Ir[t])i=Ir[t];else if(t.charAt(0)==="#"){if(t.length<6&&(s=t.charAt(1),a=t.charAt(2),o=t.charAt(3),t="#"+s+s+a+a+o+o+(t.length===5?t.charAt(4)+t.charAt(4):"")),t.length===9)return i=parseInt(t.substr(1,6),16),[i>>16,i>>8&Qt,i&Qt,parseInt(t.substr(7),16)/255];t=parseInt(t.substr(1),16),i=[t>>16,t>>8&Qt,t&Qt]}else if(t.substr(0,3)==="hsl"){if(i=g=t.match(Go),!e)l=+i[0]%360/360,c=+i[1]/100,u=+i[2]/100,a=u<=.5?u*(c+1):u+c-u*c,s=u*2-a,i.length>3&&(i[3]*=1),i[0]=Wa(l+1/3,s,a),i[1]=Wa(l,s,a),i[2]=Wa(l-1/3,s,a);else if(~t.indexOf("="))return i=t.match(Ku),n&&i.length<4&&(i[3]=1),i}else i=t.match(Go)||Ir.transparent;i=i.map(Number)}return e&&!g&&(s=i[0]/Qt,a=i[1]/Qt,o=i[2]/Qt,h=Math.max(s,a,o),f=Math.min(s,a,o),u=(h+f)/2,h===f?l=c=0:(p=h-f,c=u>.5?p/(2-h-f):p/(h+f),l=h===s?(a-o)/p+(a<o?6:0):h===a?(o-s)/p+2:(s-a)/p+4,l*=60),i[0]=~~(l+.5),i[1]=~~(c*100+.5),i[2]=~~(u*100+.5)),n&&i.length<4&&(i[3]=1),i},xh=function(t){var e=[],n=[],i=-1;return t.split(ai).forEach(function(s){var a=s.match(nr)||[];e.push.apply(e,a),n.push(i+=a.length+1)}),e.c=n,e},Zc=function(t,e,n){var i="",s=(t+i).match(ai),a=e?"hsla(":"rgba(",o=0,l,c,u,h;if(!s)return t;if(s=s.map(function(f){return(f=vh(f,e,1))&&a+(e?f[0]+","+f[1]+"%,"+f[2]+"%,"+f[3]:f.join(","))+")"}),n&&(u=xh(t),l=n.c,l.join(i)!==u.c.join(i)))for(c=t.replace(ai,"1").split(nr),h=c.length-1;o<h;o++)i+=c[o]+(~l.indexOf(o)?s.shift()||a+"0,0,0,0)":(u.length?u:s.length?s:n).shift());if(!c)for(c=t.split(ai),h=c.length-1;o<h;o++)i+=c[o]+s[o];return i+c[h]},ai=(function(){var r="(?:\\b(?:(?:rgb|rgba|hsl|hsla)\\(.+?\\))|\\B#(?:[0-9a-f]{3,4}){1,2}\\b",t;for(t in Ir)r+="|"+t+"\\b";return new RegExp(r+")","gi")})(),Y0=/hsl[a]?\(/,Mh=function(t){var e=t.join(" "),n;if(ai.lastIndex=0,ai.test(e))return n=Y0.test(e),t[1]=Zc(t[1],n),t[0]=Zc(t[0],n,xh(t[1])),!0},$r,Je=(function(){var r=Date.now,t=500,e=33,n=r(),i=n,s=1e3/240,a=s,o=[],l,c,u,h,f,p,g=function _(m){var d=r()-i,T=m===!0,E,M,b,A;if((d>t||d<0)&&(n+=d-e),i+=d,b=i-n,E=b-a,(E>0||T)&&(A=++h.frame,f=b-h.time*1e3,h.time=b=b/1e3,a+=E+(E>=s?4:s-E),M=1),T||(l=c(_)),M)for(p=0;p<o.length;p++)o[p](b,f,A,m)};return h={time:0,frame:0,tick:function(){g(!0)},deltaRatio:function(m){return f/(1e3/(m||60))},wake:function(){ju&&(!Wo&&Ml()&&(yn=Wo=window,Sl=yn.document||{},nn.gsap=Xe,(yn.gsapVersions||(yn.gsapVersions=[])).push(Xe.version),Ju($s||yn.GreenSockGlobals||!yn.gsap&&yn||{}),_h.forEach(gh)),u=typeof requestAnimationFrame<"u"&&requestAnimationFrame,l&&h.sleep(),c=u||function(m){return setTimeout(m,a-h.time*1e3+1|0)},$r=1,g(2))},sleep:function(){(u?cancelAnimationFrame:clearTimeout)(l),$r=0,c=Yr},lagSmoothing:function(m,d){t=m||1/0,e=Math.min(d||33,t)},fps:function(m){s=1e3/(m||240),a=h.time*1e3+s},add:function(m,d,T){var E=d?function(M,b,A,w){m(M,b,A,w),h.remove(E)}:m;return h.remove(m),o[T?"unshift":"push"](E),vr(),E},remove:function(m,d){~(d=o.indexOf(m))&&o.splice(d,1)&&p>=d&&p--},_listeners:o},h})(),vr=function(){return!$r&&Je.wake()},Ht={},K0=/^[\d.\-M][\d.\-,\s]/,$0=/["']/g,Z0=function(t){for(var e={},n=t.substr(1,t.length-3).split(":"),i=n[0],s=1,a=n.length,o,l,c;s<a;s++)l=n[s],o=s!==a-1?l.lastIndexOf(","):l.length,c=l.substr(0,o),e[i]=isNaN(c)?c.replace($0,"").trim():+c,i=l.substr(o+1).trim();return e},j0=function(t){var e=t.indexOf("(")+1,n=t.indexOf(")"),i=t.indexOf("(",e);return t.substring(e,~i&&i<n?t.indexOf(")",n+1):n)},J0=function(t){var e=(t+"").split("("),n=Ht[e[0]];return n&&e.length>1&&n.config?n.config.apply(null,~t.indexOf("{")?[Z0(e[1])]:j0(t).split(",").map(ih)):Ht._CE&&K0.test(t)?Ht._CE("",t):n},Sh=function(t){return function(e){return 1-t(1-e)}},yh=function r(t,e){for(var n=t._first,i;n;)n instanceof Ne?r(n,e):n.vars.yoyoEase&&(!n._yoyo||!n._repeat)&&n._yoyo!==e&&(n.timeline?r(n.timeline,e):(i=n._ease,n._ease=n._yEase,n._yEase=i,n._yoyo=e)),n=n._next},Li=function(t,e){return t&&(de(t)?t:Ht[t]||J0(t))||e},Oi=function(t,e,n,i){n===void 0&&(n=function(l){return 1-e(1-l)}),i===void 0&&(i=function(l){return l<.5?e(l*2)/2:1-e((1-l)*2)/2});var s={easeIn:e,easeOut:n,easeInOut:i},a;return He(t,function(o){Ht[o]=nn[o]=s,Ht[a=o.toLowerCase()]=n;for(var l in s)Ht[a+(l==="easeIn"?".in":l==="easeOut"?".out":".inOut")]=Ht[o+"."+l]=s[l]}),s},Eh=function(t){return function(e){return e<.5?(1-t(1-e*2))/2:.5+t((e-.5)*2)/2}},Xa=function r(t,e,n){var i=e>=1?e:1,s=(n||(t?.3:.45))/(e<1?e:1),a=s/Ho*(Math.asin(1/i)||0),o=function(u){return u===1?1:i*Math.pow(2,-10*u)*A0((u-a)*s)+1},l=t==="out"?o:t==="in"?function(c){return 1-o(1-c)}:Eh(o);return s=Ho/s,l.config=function(c,u){return r(t,c,u)},l},qa=function r(t,e){e===void 0&&(e=1.70158);var n=function(a){return a?--a*a*((e+1)*a+e)+1:0},i=t==="out"?n:t==="in"?function(s){return 1-n(1-s)}:Eh(n);return i.config=function(s){return r(t,s)},i};He("Linear,Quad,Cubic,Quart,Quint,Strong",function(r,t){var e=t<5?t+1:t;Oi(r+",Power"+(e-1),t?function(n){return Math.pow(n,e)}:function(n){return n},function(n){return 1-Math.pow(1-n,e)},function(n){return n<.5?Math.pow(n*2,e)/2:1-Math.pow((1-n)*2,e)/2})});Ht.Linear.easeNone=Ht.none=Ht.Linear.easeIn;Oi("Elastic",Xa("in"),Xa("out"),Xa());(function(r,t){var e=1/t,n=2*e,i=2.5*e,s=function(o){return o<e?r*o*o:o<n?r*Math.pow(o-1.5/t,2)+.75:o<i?r*(o-=2.25/t)*o+.9375:r*Math.pow(o-2.625/t,2)+.984375};Oi("Bounce",function(a){return 1-s(1-a)},s)})(7.5625,2.75);Oi("Expo",function(r){return Math.pow(2,10*(r-1))*r+r*r*r*r*r*r*(1-r)});Oi("Circ",function(r){return-(qu(1-r*r)-1)});Oi("Sine",function(r){return r===1?1:-b0(r*E0)+1});Oi("Back",qa("in"),qa("out"),qa());Ht.SteppedEase=Ht.steps=nn.SteppedEase={config:function(t,e){t===void 0&&(t=1);var n=1/t,i=t+(e?0:1),s=e?1:0,a=1-te;return function(o){return((i*is(0,a,o)|0)+s)*n}}};pr.ease=Ht["quad.out"];He("onComplete,onUpdate,onStart,onRepeat,onReverseComplete,onInterrupt",function(r){return Tl+=r+","+r+"Params,"});var Th=function(t,e){this.id=T0++,t._gsap=this,this.target=t,this.harness=e,this.get=e?e.get:eh,this.set=e?e.getSetter:Pl},Zr=(function(){function r(e){this.vars=e,this._delay=+e.delay||0,(this._repeat=e.repeat===1/0?-2:e.repeat||0)&&(this._rDelay=e.repeatDelay||0,this._yoyo=!!e.yoyo||!!e.yoyoEase),this._ts=1,gr(this,+e.duration,1,1),this.data=e.data,se&&(this._ctx=se,se.data.push(this)),$r||Je.wake()}var t=r.prototype;return t.delay=function(n){return n||n===0?(this.parent&&this.parent.smoothChildTiming&&this.startTime(this._start+n-this._delay),this._delay=n,this):this._delay},t.duration=function(n){return arguments.length?this.totalDuration(this._repeat>0?n+(n+this._rDelay)*this._repeat:n):this.totalDuration()&&this._dur},t.totalDuration=function(n){return arguments.length?(this._dirty=0,gr(this,this._repeat<0?n:(n-this._repeat*this._rDelay)/(this._repeat+1))):this._tDur},t.totalTime=function(n,i){if(vr(),!arguments.length)return this._tTime;var s=this._dp;if(s&&s.smoothChildTiming&&this._ts){for(oa(this,n),!s._dp||s.parent||ah(s,this);s&&s.parent;)s.parent._time!==s._start+(s._ts>=0?s._tTime/s._ts:(s.totalDuration()-s._tTime)/-s._ts)&&s.totalTime(s._tTime,!0),s=s.parent;!this.parent&&this._dp.autoRemoveChildren&&(this._ts>0&&n<this._tDur||this._ts<0&&n>0||!this._tDur&&!n)&&Tn(this._dp,this,this._start-this._delay)}return(this._tTime!==n||!this._dur&&!i||this._initted&&Math.abs(this._zTime)===te||!n&&!this._initted&&(this.add||this._ptLookup))&&(this._ts||(this._pTime=n),nh(this,n,i)),this},t.time=function(n,i){return arguments.length?this.totalTime(Math.min(this.totalDuration(),n+Yc(this))%(this._dur+this._rDelay)||(n?this._dur:0),i):this._time},t.totalProgress=function(n,i){return arguments.length?this.totalTime(this.totalDuration()*n,i):this.totalDuration()?Math.min(1,this._tTime/this._tDur):this.rawTime()>=0&&this._initted?1:0},t.progress=function(n,i){return arguments.length?this.totalTime(this.duration()*(this._yoyo&&!(this.iteration()&1)?1-n:n)+Yc(this),i):this.duration()?Math.min(1,this._time/this._dur):this.rawTime()>0?1:0},t.iteration=function(n,i){var s=this.duration()+this._rDelay;return arguments.length?this.totalTime(this._time+(n-1)*s,i):this._repeat?_r(this._tTime,s)+1:1},t.timeScale=function(n,i){if(!arguments.length)return this._rts===-te?0:this._rts;if(this._rts===n)return this;var s=this.parent&&this._ts?Js(this.parent._time,this):this._tTime;return this._rts=+n||0,this._ts=this._ps||n===-te?0:this._rts,this.totalTime(is(-Math.abs(this._delay),this.totalDuration(),s),i!==!1),aa(this),U0(this)},t.paused=function(n){return arguments.length?(this._ps!==n&&(this._ps=n,n?(this._pTime=this._tTime||Math.max(-this._delay,this.rawTime()),this._ts=this._act=0):(vr(),this._ts=this._rts,this.totalTime(this.parent&&!this.parent.smoothChildTiming?this.rawTime():this._tTime||this._pTime,this.progress()===1&&Math.abs(this._zTime)!==te&&(this._tTime-=te)))),this):this._ps},t.startTime=function(n){if(arguments.length){this._start=n;var i=this.parent||this._dp;return i&&(i._sort||!this.parent)&&Tn(i,this,n-this._delay),this}return this._start},t.endTime=function(n){return this._start+(Ve(n)?this.totalDuration():this.duration())/Math.abs(this._ts||1)},t.rawTime=function(n){var i=this.parent||this._dp;return i?n&&(!this._ts||this._repeat&&this._time&&this.totalProgress()<1)?this._tTime%(this._dur+this._rDelay):this._ts?Js(i.rawTime(n),this):this._tTime:this._tTime},t.revert=function(n){n===void 0&&(n=C0);var i=be;return be=n,Al(this)&&(this.timeline&&this.timeline.revert(n),this.totalTime(-.01,n.suppressEvents)),this.data!=="nested"&&n.kill!==!1&&this.kill(),be=i,this},t.globalTime=function(n){for(var i=this,s=arguments.length?n:i.rawTime();i;)s=i._start+s/(Math.abs(i._ts)||1),i=i._dp;return!this.parent&&this._sat?this._sat.globalTime(n):s},t.repeat=function(n){return arguments.length?(this._repeat=n===1/0?-2:n,Kc(this)):this._repeat===-2?1/0:this._repeat},t.repeatDelay=function(n){if(arguments.length){var i=this._time;return this._rDelay=n,Kc(this),i?this.time(i):this}return this._rDelay},t.yoyo=function(n){return arguments.length?(this._yoyo=n,this):this._yoyo},t.seek=function(n,i){return this.totalTime(ln(this,n),Ve(i))},t.restart=function(n,i){return this.play().totalTime(n?-this._delay:0,Ve(i)),this._dur||(this._zTime=-te),this},t.play=function(n,i){return n!=null&&this.seek(n,i),this.reversed(!1).paused(!1)},t.reverse=function(n,i){return n!=null&&this.seek(n||this.totalDuration(),i),this.reversed(!0).paused(!1)},t.pause=function(n,i){return n!=null&&this.seek(n,i),this.paused(!0)},t.resume=function(){return this.paused(!1)},t.reversed=function(n){return arguments.length?(!!n!==this.reversed()&&this.timeScale(-this._rts||(n?-te:0)),this):this._rts<0},t.invalidate=function(){return this._initted=this._act=0,this._zTime=-te,this},t.isActive=function(){var n=this.parent||this._dp,i=this._start,s;return!!(!n||this._ts&&this._initted&&n.isActive()&&(s=n.rawTime(!0))>=i&&s<this.endTime(!0)-te)},t.eventCallback=function(n,i,s){var a=this.vars;return arguments.length>1?(i?(a[n]=i,s&&(a[n+"Params"]=s),n==="onUpdate"&&(this._onUpdate=i)):delete a[n],this):a[n]},t.then=function(n){var i=this;return new Promise(function(s){var a=de(n)?n:rh,o=function(){var c=i.then;i.then=null,de(a)&&(a=a(i))&&(a.then||a===i)&&(i.then=c),s(a),i.then=c};i._initted&&i.totalProgress()===1&&i._ts>=0||!i._tTime&&i._ts<0?o():i._prom=o})},t.kill=function(){Ur(this)},r})();rn(Zr.prototype,{_time:0,_start:0,_end:0,_tTime:0,_tDur:0,_dirty:0,_repeat:0,_yoyo:!1,parent:null,_initted:!1,_rDelay:0,_ts:1,_dp:0,ratio:0,_zTime:-te,_prom:0,_ps:!1,_rts:1});var Ne=(function(r){Xu(t,r);function t(n,i){var s;return n===void 0&&(n={}),s=r.call(this,n)||this,s.labels={},s.smoothChildTiming=!!n.smoothChildTiming,s.autoRemoveChildren=!!n.autoRemoveChildren,s._sort=Ve(n.sortChildren),ue&&Tn(n.parent||ue,zn(s),i),n.reversed&&s.reverse(),n.paused&&s.paused(!0),n.scrollTrigger&&oh(zn(s),n.scrollTrigger),s}var e=t.prototype;return e.to=function(i,s,a){return Br(0,arguments,this),this},e.from=function(i,s,a){return Br(1,arguments,this),this},e.fromTo=function(i,s,a,o){return Br(2,arguments,this),this},e.set=function(i,s,a){return s.duration=0,s.parent=this,Or(s).repeatDelay||(s.repeat=0),s.immediateRender=!!s.immediateRender,new ge(i,s,ln(this,a),1),this},e.call=function(i,s,a){return Tn(this,ge.delayedCall(0,i,s),a)},e.staggerTo=function(i,s,a,o,l,c,u){return a.duration=s,a.stagger=a.stagger||o,a.onComplete=c,a.onCompleteParams=u,a.parent=this,new ge(i,a,ln(this,l)),this},e.staggerFrom=function(i,s,a,o,l,c,u){return a.runBackwards=1,Or(a).immediateRender=Ve(a.immediateRender),this.staggerTo(i,s,a,o,l,c,u)},e.staggerFromTo=function(i,s,a,o,l,c,u,h){return o.startAt=a,Or(o).immediateRender=Ve(o.immediateRender),this.staggerTo(i,s,o,l,c,u,h)},e.render=function(i,s,a){var o=this._time,l=this._dirty?this.totalDuration():this._tDur,c=this._dur,u=i<=0?0:ve(i),h=this._zTime<0!=i<0&&(this._initted||!c),f,p,g,_,m,d,T,E,M,b,A,w;if(this!==ue&&u>l&&i>=0&&(u=l),u!==this._tTime||a||h){if(o!==this._time&&c&&(u+=this._time-o,i+=this._time-o),f=u,M=this._start,E=this._ts,d=!E,h&&(c||(o=this._zTime),(i||!s)&&(this._zTime=i)),this._repeat){if(A=this._yoyo,m=c+this._rDelay,this._repeat<-1&&i<0)return this.totalTime(m*100+i,s,a);if(f=ve(u%m),u===l?(_=this._repeat,f=c):(b=ve(u/m),_=~~b,_&&_===b&&(f=c,_--),f>c&&(f=c)),b=_r(this._tTime,m),!o&&this._tTime&&b!==_&&this._tTime-b*m-this._dur<=0&&(b=_),A&&_&1&&(f=c-f,w=1),_!==b&&!this._lock){var C=A&&b&1,x=C===(A&&_&1);if(_<b&&(C=!C),o=C?0:u%c?c:u,this._lock=1,this.render(o||(w?0:ve(_*m)),s,!c)._lock=0,this._tTime=u,!s&&this.parent&&Qe(this,"onRepeat"),this.vars.repeatRefresh&&!w&&(this.invalidate()._lock=1),o&&o!==this._time||d!==!this._ts||this.vars.onRepeat&&!this.parent&&!this._act)return this;if(c=this._dur,l=this._tDur,x&&(this._lock=2,o=C?c:-1e-4,this.render(o,!0),this.vars.repeatRefresh&&!w&&this.invalidate()),this._lock=0,!this._ts&&!d)return this;yh(this,w)}}if(this._hasPause&&!this._forcing&&this._lock<2&&(T=O0(this,ve(o),ve(f)),T&&(u-=f-(f=T._start))),this._tTime=u,this._time=f,this._act=!E,this._initted||(this._onUpdate=this.vars.onUpdate,this._initted=1,this._zTime=i,o=0),!o&&u&&!s&&!b&&(Qe(this,"onStart"),this._tTime!==u))return this;if(f>=o&&i>=0)for(p=this._first;p;){if(g=p._next,(p._act||f>=p._start)&&p._ts&&T!==p){if(p.parent!==this)return this.render(i,s,a);if(p.render(p._ts>0?(f-p._start)*p._ts:(p._dirty?p.totalDuration():p._tDur)+(f-p._start)*p._ts,s,a),f!==this._time||!this._ts&&!d){T=0,g&&(u+=this._zTime=-te);break}}p=g}else{p=this._last;for(var y=i<0?i:f;p;){if(g=p._prev,(p._act||y<=p._end)&&p._ts&&T!==p){if(p.parent!==this)return this.render(i,s,a);if(p.render(p._ts>0?(y-p._start)*p._ts:(p._dirty?p.totalDuration():p._tDur)+(y-p._start)*p._ts,s,a||be&&Al(p)),f!==this._time||!this._ts&&!d){T=0,g&&(u+=this._zTime=y?-te:te);break}}p=g}}if(T&&!s&&(this.pause(),T.render(f>=o?0:-te)._zTime=f>=o?1:-1,this._ts))return this._start=M,aa(this),this.render(i,s,a);this._onUpdate&&!s&&Qe(this,"onUpdate",!0),(u===l&&this._tTime>=this.totalDuration()||!u&&o)&&(M===this._start||Math.abs(E)!==Math.abs(this._ts))&&(this._lock||((i||!c)&&(u===l&&this._ts>0||!u&&this._ts<0)&&li(this,1),!s&&!(i<0&&!o)&&(u||o||!l)&&(Qe(this,u===l&&i>=0?"onComplete":"onReverseComplete",!0),this._prom&&!(u<l&&this.timeScale()>0)&&this._prom())))}return this},e.add=function(i,s){var a=this;if(qn(s)||(s=ln(this,s,i)),!(i instanceof Zr)){if(Le(i))return i.forEach(function(o){return a.add(o,s)}),this;if(Ee(i))return this.addLabel(i,s);if(de(i))i=ge.delayedCall(0,i);else return this}return this!==i?Tn(this,i,s):this},e.getChildren=function(i,s,a,o){i===void 0&&(i=!0),s===void 0&&(s=!0),a===void 0&&(a=!0),o===void 0&&(o=-un);for(var l=[],c=this._first;c;)c._start>=o&&(c instanceof ge?s&&l.push(c):(a&&l.push(c),i&&l.push.apply(l,c.getChildren(!0,s,a)))),c=c._next;return l},e.getById=function(i){for(var s=this.getChildren(1,1,1),a=s.length;a--;)if(s[a].vars.id===i)return s[a]},e.remove=function(i){return Ee(i)?this.removeLabel(i):de(i)?this.killTweensOf(i):(i.parent===this&&sa(this,i),i===this._recent&&(this._recent=this._last),Di(this))},e.totalTime=function(i,s){return arguments.length?(this._forcing=1,!this._dp&&this._ts&&(this._start=ve(Je.time-(this._ts>0?i/this._ts:(this.totalDuration()-i)/-this._ts))),r.prototype.totalTime.call(this,i,s),this._forcing=0,this):this._tTime},e.addLabel=function(i,s){return this.labels[i]=ln(this,s),this},e.removeLabel=function(i){return delete this.labels[i],this},e.addPause=function(i,s,a){var o=ge.delayedCall(0,s||Yr,a);return o.data="isPause",this._hasPause=1,Tn(this,o,ln(this,i))},e.removePause=function(i){var s=this._first;for(i=ln(this,i);s;)s._start===i&&s.data==="isPause"&&li(s),s=s._next},e.killTweensOf=function(i,s,a){for(var o=this.getTweensOf(i,a),l=o.length;l--;)ei!==o[l]&&o[l].kill(i,s);return this},e.getTweensOf=function(i,s){for(var a=[],o=hn(i),l=this._first,c=qn(s),u;l;)l instanceof ge?P0(l._targets,o)&&(c?(!ei||l._initted&&l._ts)&&l.globalTime(0)<=s&&l.globalTime(l.totalDuration())>s:!s||l.isActive())&&a.push(l):(u=l.getTweensOf(o,s)).length&&a.push.apply(a,u),l=l._next;return a},e.tweenTo=function(i,s){s=s||{};var a=this,o=ln(a,i),l=s,c=l.startAt,u=l.onStart,h=l.onStartParams,f=l.immediateRender,p,g=ge.to(a,rn({ease:s.ease||"none",lazy:!1,immediateRender:!1,time:o,overwrite:"auto",duration:s.duration||Math.abs((o-(c&&"time"in c?c.time:a._time))/a.timeScale())||te,onStart:function(){if(a.pause(),!p){var m=s.duration||Math.abs((o-(c&&"time"in c?c.time:a._time))/a.timeScale());g._dur!==m&&gr(g,m,0,1).render(g._time,!0,!0),p=1}u&&u.apply(g,h||[])}},s));return f?g.render(0):g},e.tweenFromTo=function(i,s,a){return this.tweenTo(s,rn({startAt:{time:ln(this,i)}},a))},e.recent=function(){return this._recent},e.nextLabel=function(i){return i===void 0&&(i=this._time),$c(this,ln(this,i))},e.previousLabel=function(i){return i===void 0&&(i=this._time),$c(this,ln(this,i),1)},e.currentLabel=function(i){return arguments.length?this.seek(i,!0):this.previousLabel(this._time+te)},e.shiftChildren=function(i,s,a){a===void 0&&(a=0);for(var o=this._first,l=this.labels,c;o;)o._start>=a&&(o._start+=i,o._end+=i),o=o._next;if(s)for(c in l)l[c]>=a&&(l[c]+=i);return Di(this)},e.invalidate=function(i){var s=this._first;for(this._lock=0;s;)s.invalidate(i),s=s._next;return r.prototype.invalidate.call(this,i)},e.clear=function(i){i===void 0&&(i=!0);for(var s=this._first,a;s;)a=s._next,this.remove(s),s=a;return this._dp&&(this._time=this._tTime=this._pTime=0),i&&(this.labels={}),Di(this)},e.totalDuration=function(i){var s=0,a=this,o=a._last,l=un,c,u,h;if(arguments.length)return a.timeScale((a._repeat<0?a.duration():a.totalDuration())/(a.reversed()?-i:i));if(a._dirty){for(h=a.parent;o;)c=o._prev,o._dirty&&o.totalDuration(),u=o._start,u>l&&a._sort&&o._ts&&!a._lock?(a._lock=1,Tn(a,o,u-o._delay,1)._lock=0):l=u,u<0&&o._ts&&(s-=u,(!h&&!a._dp||h&&h.smoothChildTiming)&&(a._start+=u/a._ts,a._time-=u,a._tTime-=u),a.shiftChildren(-u,!1,-1/0),l=0),o._end>s&&o._ts&&(s=o._end),o=c;gr(a,a===ue&&a._time>s?a._time:s,1,1),a._dirty=0}return a._tDur},t.updateRoot=function(i){if(ue._ts&&(nh(ue,Js(i,ue)),th=Je.frame),Je.frame>=Xc){Xc+=tn.autoSleep||120;var s=ue._first;if((!s||!s._ts)&&tn.autoSleep&&Je._listeners.length<2){for(;s&&!s._ts;)s=s._next;s||Je.sleep()}}},t})(Zr);rn(Ne.prototype,{_lock:0,_hasPause:0,_forcing:0});var Q0=function(t,e,n,i,s,a,o){var l=new Ge(this._pt,t,e,0,1,Ph,null,s),c=0,u=0,h,f,p,g,_,m,d,T;for(l.b=n,l.e=i,n+="",i+="",(d=~i.indexOf("random("))&&(i=Kr(i)),a&&(T=[n,i],a(T,t,e),n=T[0],i=T[1]),f=n.match(Ha)||[];h=Ha.exec(i);)g=h[0],_=i.substring(c,h.index),p?p=(p+1)%5:_.substr(-5)==="rgba("&&(p=1),g!==f[u++]&&(m=parseFloat(f[u-1])||0,l._pt={_next:l._pt,p:_||u===1?_:",",s:m,c:g.charAt(1)==="="?ar(m,g)-m:parseFloat(g)-m,m:p&&p<4?Math.round:0},c=Ha.lastIndex);return l.c=c<i.length?i.substring(c,i.length):"",l.fp=o,($u.test(i)||d)&&(l.e=0),this._pt=l,l},wl=function(t,e,n,i,s,a,o,l,c,u){de(i)&&(i=i(s||0,t,a));var h=t[e],f=n!=="get"?n:de(h)?c?t[e.indexOf("set")||!de(t["get"+e.substr(3)])?e:"get"+e.substr(3)](c):t[e]():h,p=de(h)?c?rv:Rh:Cl,g;if(Ee(i)&&(~i.indexOf("random(")&&(i=Kr(i)),i.charAt(1)==="="&&(g=ar(f,i)+(Ce(f)||0),(g||g===0)&&(i=g))),!u||f!==i||jo)return!isNaN(f*i)&&i!==""?(g=new Ge(this._pt,t,e,+f||0,i-(f||0),typeof h=="boolean"?av:Ch,0,p),c&&(g.fp=c),o&&g.modifier(o,this,t),this._pt=g):(!h&&!(e in t)&&yl(e,i),Q0.call(this,t,e,f,i,p,l||tn.stringFilter,c))},tv=function(t,e,n,i,s){if(de(t)&&(t=zr(t,s,e,n,i)),!Dn(t)||t.style&&t.nodeType||Le(t)||Yu(t))return Ee(t)?zr(t,s,e,n,i):t;var a={},o;for(o in t)a[o]=zr(t[o],s,e,n,i);return a},bh=function(t,e,n,i,s,a){var o,l,c,u;if(Ze[t]&&(o=new Ze[t]).init(s,o.rawVars?e[t]:tv(e[t],i,s,a,n),n,i,a)!==!1&&(n._pt=l=new Ge(n._pt,s,t,0,1,o.render,o,0,o.priority),n!==ir))for(c=n._ptLookup[n._targets.indexOf(s)],u=o._props.length;u--;)c[o._props[u]]=l;return o},ei,jo,Rl=function r(t,e,n){var i=t.vars,s=i.ease,a=i.startAt,o=i.immediateRender,l=i.lazy,c=i.onUpdate,u=i.runBackwards,h=i.yoyoEase,f=i.keyframes,p=i.autoRevert,g=t._dur,_=t._startAt,m=t._targets,d=t.parent,T=d&&d.data==="nested"?d.vars.targets:m,E=t._overwrite==="auto"&&!vl,M=t.timeline,b,A,w,C,x,y,D,N,B,X,H,G,Y;if(M&&(!f||!s)&&(s="none"),t._ease=Li(s,pr.ease),t._yEase=h?Sh(Li(h===!0?s:h,pr.ease)):0,h&&t._yoyo&&!t._repeat&&(h=t._yEase,t._yEase=t._ease,t._ease=h),t._from=!M&&!!i.runBackwards,!M||f&&!i.stagger){if(N=m[0]?Pi(m[0]).harness:0,G=N&&i[N.prop],b=js(i,El),_&&(_._zTime<0&&_.progress(1),e<0&&u&&o&&!p?_.render(-1,!0):_.revert(u&&g?zs:R0),_._lazy=0),a){if(li(t._startAt=ge.set(m,rn({data:"isStart",overwrite:!1,parent:d,immediateRender:!0,lazy:!_&&Ve(l),startAt:null,delay:0,onUpdate:c&&function(){return Qe(t,"onUpdate")},stagger:0},a))),t._startAt._dp=0,t._startAt._sat=t,e<0&&(be||!o&&!p)&&t._startAt.revert(zs),o&&g&&e<=0&&n<=0){e&&(t._zTime=e);return}}else if(u&&g&&!_){if(e&&(o=!1),w=rn({overwrite:!1,data:"isFromStart",lazy:o&&!_&&Ve(l),immediateRender:o,stagger:0,parent:d},b),G&&(w[N.prop]=G),li(t._startAt=ge.set(m,w)),t._startAt._dp=0,t._startAt._sat=t,e<0&&(be?t._startAt.revert(zs):t._startAt.render(-1,!0)),t._zTime=e,!o)r(t._startAt,te,te);else if(!e)return}for(t._pt=t._ptCache=0,l=g&&Ve(l)||l&&!g,A=0;A<m.length;A++){if(x=m[A],D=x._gsap||bl(m)[A]._gsap,t._ptLookup[A]=X={},Xo[D.id]&&si.length&&Zs(),H=T===m?A:T.indexOf(x),N&&(B=new N).init(x,G||b,t,H,T)!==!1&&(t._pt=C=new Ge(t._pt,x,B.name,0,1,B.render,B,0,B.priority),B._props.forEach(function(k){X[k]=C}),B.priority&&(y=1)),!N||G)for(w in b)Ze[w]&&(B=bh(w,b,t,H,x,T))?B.priority&&(y=1):X[w]=C=wl.call(t,x,w,"get",b[w],H,T,0,i.stringFilter);t._op&&t._op[A]&&t.kill(x,t._op[A]),E&&t._pt&&(ei=t,ue.killTweensOf(x,X,t.globalTime(e)),Y=!t.parent,ei=0),t._pt&&l&&(Xo[D.id]=1)}y&&Dh(t),t._onInit&&t._onInit(t)}t._onUpdate=c,t._initted=(!t._op||t._pt)&&!Y,f&&e<=0&&M.render(un,!0,!0)},ev=function(t,e,n,i,s,a,o,l){var c=(t._pt&&t._ptCache||(t._ptCache={}))[e],u,h,f,p;if(!c)for(c=t._ptCache[e]=[],f=t._ptLookup,p=t._targets.length;p--;){if(u=f[p][e],u&&u.d&&u.d._pt)for(u=u.d._pt;u&&u.p!==e&&u.fp!==e;)u=u._next;if(!u)return jo=1,t.vars[e]="+=0",Rl(t,o),jo=0,l?qr(e+" not eligible for reset"):1;c.push(u)}for(p=c.length;p--;)h=c[p],u=h._pt||h,u.s=(i||i===0)&&!s?i:u.s+(i||0)+a*u.c,u.c=n-u.s,h.e&&(h.e=me(n)+Ce(h.e)),h.b&&(h.b=u.s+Ce(h.b))},nv=function(t,e){var n=t[0]?Pi(t[0]).harness:0,i=n&&n.aliases,s,a,o,l;if(!i)return e;s=mr({},e);for(a in i)if(a in s)for(l=i[a].split(","),o=l.length;o--;)s[l[o]]=s[a];return s},iv=function(t,e,n,i){var s=e.ease||i||"power1.inOut",a,o;if(Le(e))o=n[t]||(n[t]=[]),e.forEach(function(l,c){return o.push({t:c/(e.length-1)*100,v:l,e:s})});else for(a in e)o=n[a]||(n[a]=[]),a==="ease"||o.push({t:parseFloat(t),v:e[a],e:s})},zr=function(t,e,n,i,s){return de(t)?t.call(e,n,i,s):Ee(t)&&~t.indexOf("random(")?Kr(t):t},Ah=Tl+"repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase,autoRevert",wh={};He(Ah+",id,stagger,delay,duration,paused,scrollTrigger",function(r){return wh[r]=1});var ge=(function(r){Xu(t,r);function t(n,i,s,a){var o;typeof i=="number"&&(s.duration=i,i=s,s=null),o=r.call(this,a?i:Or(i))||this;var l=o.vars,c=l.duration,u=l.delay,h=l.immediateRender,f=l.stagger,p=l.overwrite,g=l.keyframes,_=l.defaults,m=l.scrollTrigger,d=l.yoyoEase,T=i.parent||ue,E=(Le(n)||Yu(n)?qn(n[0]):"length"in i)?[n]:hn(n),M,b,A,w,C,x,y,D;if(o._targets=E.length?bl(E):qr("GSAP target "+n+" not found. https://gsap.com",!tn.nullTargetWarn)||[],o._ptLookup=[],o._overwrite=p,g||f||Us(c)||Us(u)){if(i=o.vars,M=o.timeline=new Ne({data:"nested",defaults:_||{},targets:T&&T.data==="nested"?T.vars.targets:E}),M.kill(),M.parent=M._dp=zn(o),M._start=0,f||Us(c)||Us(u)){if(w=E.length,y=f&&hh(f),Dn(f))for(C in f)~Ah.indexOf(C)&&(D||(D={}),D[C]=f[C]);for(b=0;b<w;b++)A=js(i,wh),A.stagger=0,d&&(A.yoyoEase=d),D&&mr(A,D),x=E[b],A.duration=+zr(c,zn(o),b,x,E),A.delay=(+zr(u,zn(o),b,x,E)||0)-o._delay,!f&&w===1&&A.delay&&(o._delay=u=A.delay,o._start+=u,A.delay=0),M.to(x,A,y?y(b,x,E):0),M._ease=Ht.none;M.duration()?c=u=0:o.timeline=0}else if(g){Or(rn(M.vars.defaults,{ease:"none"})),M._ease=Li(g.ease||i.ease||"none");var N=0,B,X,H;if(Le(g))g.forEach(function(G){return M.to(E,G,">")}),M.duration();else{A={};for(C in g)C==="ease"||C==="easeEach"||iv(C,g[C],A,g.easeEach);for(C in A)for(B=A[C].sort(function(G,Y){return G.t-Y.t}),N=0,b=0;b<B.length;b++)X=B[b],H={ease:X.e,duration:(X.t-(b?B[b-1].t:0))/100*c},H[C]=X.v,M.to(E,H,N),N+=H.duration;M.duration()<c&&M.to({},{duration:c-M.duration()})}}c||o.duration(c=M.duration())}else o.timeline=0;return p===!0&&!vl&&(ei=zn(o),ue.killTweensOf(E),ei=0),Tn(T,zn(o),s),i.reversed&&o.reverse(),i.paused&&o.paused(!0),(h||!c&&!g&&o._start===ve(T._time)&&Ve(h)&&I0(zn(o))&&T.data!=="nested")&&(o._tTime=-te,o.render(Math.max(0,-u)||0)),m&&oh(zn(o),m),o}var e=t.prototype;return e.render=function(i,s,a){var o=this._time,l=this._tDur,c=this._dur,u=i<0,h=i>l-te&&!u?l:i<te?0:i,f,p,g,_,m,d,T,E,M;if(!c)N0(this,i,s,a);else if(h!==this._tTime||!i||a||!this._initted&&this._tTime||this._startAt&&this._zTime<0!==u||this._lazy){if(f=h,E=this.timeline,this._repeat){if(_=c+this._rDelay,this._repeat<-1&&u)return this.totalTime(_*100+i,s,a);if(f=ve(h%_),h===l?(g=this._repeat,f=c):(m=ve(h/_),g=~~m,g&&g===m?(f=c,g--):f>c&&(f=c)),d=this._yoyo&&g&1,d&&(M=this._yEase,f=c-f),m=_r(this._tTime,_),f===o&&!a&&this._initted&&g===m)return this._tTime=h,this;g!==m&&(E&&this._yEase&&yh(E,d),this.vars.repeatRefresh&&!d&&!this._lock&&f!==_&&this._initted&&(this._lock=a=1,this.render(ve(_*g),!0).invalidate()._lock=0))}if(!this._initted){if(lh(this,u?i:f,a,s,h))return this._tTime=0,this;if(o!==this._time&&!(a&&this.vars.repeatRefresh&&g!==m))return this;if(c!==this._dur)return this.render(i,s,a)}if(this._tTime=h,this._time=f,!this._act&&this._ts&&(this._act=1,this._lazy=0),this.ratio=T=(M||this._ease)(f/c),this._from&&(this.ratio=T=1-T),!o&&h&&!s&&!m&&(Qe(this,"onStart"),this._tTime!==h))return this;for(p=this._pt;p;)p.r(T,p.d),p=p._next;E&&E.render(i<0?i:E._dur*E._ease(f/this._dur),s,a)||this._startAt&&(this._zTime=i),this._onUpdate&&!s&&(u&&qo(this,i,s,a),Qe(this,"onUpdate")),this._repeat&&g!==m&&this.vars.onRepeat&&!s&&this.parent&&Qe(this,"onRepeat"),(h===this._tDur||!h)&&this._tTime===h&&(u&&!this._onUpdate&&qo(this,i,!0,!0),(i||!c)&&(h===this._tDur&&this._ts>0||!h&&this._ts<0)&&li(this,1),!s&&!(u&&!o)&&(h||o||d)&&(Qe(this,h===l?"onComplete":"onReverseComplete",!0),this._prom&&!(h<l&&this.timeScale()>0)&&this._prom()))}return this},e.targets=function(){return this._targets},e.invalidate=function(i){return(!i||!this.vars.runBackwards)&&(this._startAt=0),this._pt=this._op=this._onUpdate=this._lazy=this.ratio=0,this._ptLookup=[],this.timeline&&this.timeline.invalidate(i),r.prototype.invalidate.call(this,i)},e.resetTo=function(i,s,a,o,l){$r||Je.wake(),this._ts||this.play();var c=Math.min(this._dur,(this._dp._time-this._start)*this._ts),u;return this._initted||Rl(this,c),u=this._ease(c/this._dur),ev(this,i,s,a,o,u,c,l)?this.resetTo(i,s,a,o,1):(oa(this,0),this.parent||sh(this._dp,this,"_first","_last",this._dp._sort?"_start":0),this.render(0))},e.kill=function(i,s){if(s===void 0&&(s="all"),!i&&(!s||s==="all"))return this._lazy=this._pt=0,this.parent?Ur(this):this.scrollTrigger&&this.scrollTrigger.kill(!!be),this;if(this.timeline){var a=this.timeline.totalDuration();return this.timeline.killTweensOf(i,s,ei&&ei.vars.overwrite!==!0)._first||Ur(this),this.parent&&a!==this.timeline.totalDuration()&&gr(this,this._dur*this.timeline._tDur/a,0,1),this}var o=this._targets,l=i?hn(i):o,c=this._ptLookup,u=this._pt,h,f,p,g,_,m,d;if((!s||s==="all")&&L0(o,l))return s==="all"&&(this._pt=0),Ur(this);for(h=this._op=this._op||[],s!=="all"&&(Ee(s)&&(_={},He(s,function(T){return _[T]=1}),s=_),s=nv(o,s)),d=o.length;d--;)if(~l.indexOf(o[d])){f=c[d],s==="all"?(h[d]=s,g=f,p={}):(p=h[d]=h[d]||{},g=s);for(_ in g)m=f&&f[_],m&&((!("kill"in m.d)||m.d.kill(_)===!0)&&sa(this,m,"_pt"),delete f[_]),p!=="all"&&(p[_]=1)}return this._initted&&!this._pt&&u&&Ur(this),this},t.to=function(i,s){return new t(i,s,arguments[2])},t.from=function(i,s){return Br(1,arguments)},t.delayedCall=function(i,s,a,o){return new t(s,0,{immediateRender:!1,lazy:!1,overwrite:!1,delay:i,onComplete:s,onReverseComplete:s,onCompleteParams:a,onReverseCompleteParams:a,callbackScope:o})},t.fromTo=function(i,s,a){return Br(2,arguments)},t.set=function(i,s){return s.duration=0,s.repeatDelay||(s.repeat=0),new t(i,s)},t.killTweensOf=function(i,s,a){return ue.killTweensOf(i,s,a)},t})(Zr);rn(ge.prototype,{_targets:[],_lazy:0,_startAt:0,_op:0,_onInit:0});He("staggerTo,staggerFrom,staggerFromTo",function(r){ge[r]=function(){var t=new Ne,e=Ko.call(arguments,0);return e.splice(r==="staggerFromTo"?5:4,0,0),t[r].apply(t,e)}});var Cl=function(t,e,n){return t[e]=n},Rh=function(t,e,n){return t[e](n)},rv=function(t,e,n,i){return t[e](i.fp,n)},sv=function(t,e,n){return t.setAttribute(e,n)},Pl=function(t,e){return de(t[e])?Rh:xl(t[e])&&t.setAttribute?sv:Cl},Ch=function(t,e){return e.set(e.t,e.p,Math.round((e.s+e.c*t)*1e6)/1e6,e)},av=function(t,e){return e.set(e.t,e.p,!!(e.s+e.c*t),e)},Ph=function(t,e){var n=e._pt,i="";if(!t&&e.b)i=e.b;else if(t===1&&e.e)i=e.e;else{for(;n;)i=n.p+(n.m?n.m(n.s+n.c*t):Math.round((n.s+n.c*t)*1e4)/1e4)+i,n=n._next;i+=e.c}e.set(e.t,e.p,i,e)},Dl=function(t,e){for(var n=e._pt;n;)n.r(t,n.d),n=n._next},ov=function(t,e,n,i){for(var s=this._pt,a;s;)a=s._next,s.p===i&&s.modifier(t,e,n),s=a},lv=function(t){for(var e=this._pt,n,i;e;)i=e._next,e.p===t&&!e.op||e.op===t?sa(this,e,"_pt"):e.dep||(n=1),e=i;return!n},cv=function(t,e,n,i){i.mSet(t,e,i.m.call(i.tween,n,i.mt),i)},Dh=function(t){for(var e=t._pt,n,i,s,a;e;){for(n=e._next,i=s;i&&i.pr>e.pr;)i=i._next;(e._prev=i?i._prev:a)?e._prev._next=e:s=e,(e._next=i)?i._prev=e:a=e,e=n}t._pt=s},Ge=(function(){function r(e,n,i,s,a,o,l,c,u){this.t=n,this.s=s,this.c=a,this.p=i,this.r=o||Ch,this.d=l||this,this.set=c||Cl,this.pr=u||0,this._next=e,e&&(e._prev=this)}var t=r.prototype;return t.modifier=function(n,i,s){this.mSet=this.mSet||this.set,this.set=cv,this.m=n,this.mt=s,this.tween=i},r})();He(Tl+"parent,duration,ease,delay,overwrite,runBackwards,startAt,yoyo,immediateRender,repeat,repeatDelay,data,paused,reversed,lazy,callbackScope,stringFilter,id,yoyoEase,stagger,inherit,repeatRefresh,keyframes,autoRevert,scrollTrigger",function(r){return El[r]=1});nn.TweenMax=nn.TweenLite=ge;nn.TimelineLite=nn.TimelineMax=Ne;ue=new Ne({sortChildren:!1,defaults:pr,autoRemoveChildren:!0,id:"root",smoothChildTiming:!0});tn.stringFilter=Mh;var Ui=[],Vs={},uv=[],jc=0,hv=0,Ya=function(t){return(Vs[t]||uv).map(function(e){return e()})},Jo=function(){var t=Date.now(),e=[];t-jc>2&&(Ya("matchMediaInit"),Ui.forEach(function(n){var i=n.queries,s=n.conditions,a,o,l,c;for(o in i)a=yn.matchMedia(i[o]).matches,a&&(l=1),a!==s[o]&&(s[o]=a,c=1);c&&(n.revert(),l&&e.push(n))}),Ya("matchMediaRevert"),e.forEach(function(n){return n.onMatch(n,function(i){return n.add(null,i)})}),jc=t,Ya("matchMedia"))},Lh=(function(){function r(e,n){this.selector=n&&$o(n),this.data=[],this._r=[],this.isReverted=!1,this.id=hv++,e&&this.add(e)}var t=r.prototype;return t.add=function(n,i,s){de(n)&&(s=i,i=n,n=de);var a=this,o=function(){var c=se,u=a.selector,h;return c&&c!==a&&c.data.push(a),s&&(a.selector=$o(s)),se=a,h=i.apply(a,arguments),de(h)&&a._r.push(h),se=c,a.selector=u,a.isReverted=!1,h};return a.last=o,n===de?o(a,function(l){return a.add(null,l)}):n?a[n]=o:o},t.ignore=function(n){var i=se;se=null,n(this),se=i},t.getTweens=function(){var n=[];return this.data.forEach(function(i){return i instanceof r?n.push.apply(n,i.getTweens()):i instanceof ge&&!(i.parent&&i.parent.data==="nested")&&n.push(i)}),n},t.clear=function(){this._r.length=this.data.length=0},t.kill=function(n,i){var s=this;if(n?(function(){for(var o=s.getTweens(),l=s.data.length,c;l--;)c=s.data[l],c.data==="isFlip"&&(c.revert(),c.getChildren(!0,!0,!1).forEach(function(u){return o.splice(o.indexOf(u),1)}));for(o.map(function(u){return{g:u._dur||u._delay||u._sat&&!u._sat.vars.immediateRender?u.globalTime(0):-1/0,t:u}}).sort(function(u,h){return h.g-u.g||-1/0}).forEach(function(u){return u.t.revert(n)}),l=s.data.length;l--;)c=s.data[l],c instanceof Ne?c.data!=="nested"&&(c.scrollTrigger&&c.scrollTrigger.revert(),c.kill()):!(c instanceof ge)&&c.revert&&c.revert(n);s._r.forEach(function(u){return u(n,s)}),s.isReverted=!0})():this.data.forEach(function(o){return o.kill&&o.kill()}),this.clear(),i)for(var a=Ui.length;a--;)Ui[a].id===this.id&&Ui.splice(a,1)},t.revert=function(n){this.kill(n||{})},r})(),fv=(function(){function r(e){this.contexts=[],this.scope=e,se&&se.data.push(this)}var t=r.prototype;return t.add=function(n,i,s){Dn(n)||(n={matches:n});var a=new Lh(0,s||this.scope),o=a.conditions={},l,c,u;se&&!a.selector&&(a.selector=se.selector),this.contexts.push(a),i=a.add("onMatch",i),a.queries=n;for(c in n)c==="all"?u=1:(l=yn.matchMedia(n[c]),l&&(Ui.indexOf(a)<0&&Ui.push(a),(o[c]=l.matches)&&(u=1),l.addListener?l.addListener(Jo):l.addEventListener("change",Jo)));return u&&i(a,function(h){return a.add(null,h)}),this},t.revert=function(n){this.kill(n||{})},t.kill=function(n){this.contexts.forEach(function(i){return i.kill(n,!0)})},r})(),Qs={registerPlugin:function(){for(var t=arguments.length,e=new Array(t),n=0;n<t;n++)e[n]=arguments[n];e.forEach(function(i){return gh(i)})},timeline:function(t){return new Ne(t)},getTweensOf:function(t,e){return ue.getTweensOf(t,e)},getProperty:function(t,e,n,i){Ee(t)&&(t=hn(t)[0]);var s=Pi(t||{}).get,a=n?rh:ih;return n==="native"&&(n=""),t&&(e?a((Ze[e]&&Ze[e].get||s)(t,e,n,i)):function(o,l,c){return a((Ze[o]&&Ze[o].get||s)(t,o,l,c))})},quickSetter:function(t,e,n){if(t=hn(t),t.length>1){var i=t.map(function(u){return Xe.quickSetter(u,e,n)}),s=i.length;return function(u){for(var h=s;h--;)i[h](u)}}t=t[0]||{};var a=Ze[e],o=Pi(t),l=o.harness&&(o.harness.aliases||{})[e]||e,c=a?function(u){var h=new a;ir._pt=0,h.init(t,n?u+n:u,ir,0,[t]),h.render(1,h),ir._pt&&Dl(1,ir)}:o.set(t,l);return a?c:function(u){return c(t,l,n?u+n:u,o,1)}},quickTo:function(t,e,n){var i,s=Xe.to(t,rn((i={},i[e]="+=0.1",i.paused=!0,i.stagger=0,i),n||{})),a=function(l,c,u){return s.resetTo(e,l,c,u)};return a.tween=s,a},isTweening:function(t){return ue.getTweensOf(t,!0).length>0},defaults:function(t){return t&&t.ease&&(t.ease=Li(t.ease,pr.ease)),qc(pr,t||{})},config:function(t){return qc(tn,t||{})},registerEffect:function(t){var e=t.name,n=t.effect,i=t.plugins,s=t.defaults,a=t.extendTimeline;(i||"").split(",").forEach(function(o){return o&&!Ze[o]&&!nn[o]&&qr(e+" effect requires "+o+" plugin.")}),Ga[e]=function(o,l,c){return n(hn(o),rn(l||{},s),c)},a&&(Ne.prototype[e]=function(o,l,c){return this.add(Ga[e](o,Dn(l)?l:(c=l)&&{},this),c)})},registerEase:function(t,e){Ht[t]=Li(e)},parseEase:function(t,e){return arguments.length?Li(t,e):Ht},getById:function(t){return ue.getById(t)},exportRoot:function(t,e){t===void 0&&(t={});var n=new Ne(t),i,s;for(n.smoothChildTiming=Ve(t.smoothChildTiming),ue.remove(n),n._dp=0,n._time=n._tTime=ue._time,i=ue._first;i;)s=i._next,(e||!(!i._dur&&i instanceof ge&&i.vars.onComplete===i._targets[0]))&&Tn(n,i,i._start-i._delay),i=s;return Tn(ue,n,0),n},context:function(t,e){return t?new Lh(t,e):se},matchMedia:function(t){return new fv(t)},matchMediaRefresh:function(){return Ui.forEach(function(t){var e=t.conditions,n,i;for(i in e)e[i]&&(e[i]=!1,n=1);n&&t.revert()})||Jo()},addEventListener:function(t,e){var n=Vs[t]||(Vs[t]=[]);~n.indexOf(e)||n.push(e)},removeEventListener:function(t,e){var n=Vs[t],i=n&&n.indexOf(e);i>=0&&n.splice(i,1)},utils:{wrap:W0,wrapYoyo:X0,distribute:hh,random:dh,snap:fh,normalize:G0,getUnit:Ce,clamp:z0,splitColor:vh,toArray:hn,selector:$o,mapRange:mh,pipe:V0,unitize:H0,interpolate:q0,shuffle:uh},install:Ju,effects:Ga,ticker:Je,updateRoot:Ne.updateRoot,plugins:Ze,globalTimeline:ue,core:{PropTween:Ge,globals:Qu,Tween:ge,Timeline:Ne,Animation:Zr,getCache:Pi,_removeLinkedListItem:sa,reverting:function(){return be},context:function(t){return t&&se&&(se.data.push(t),t._ctx=se),se},suppressOverwrites:function(t){return vl=t}}};He("to,from,fromTo,delayedCall,set,killTweensOf",function(r){return Qs[r]=ge[r]});Je.add(Ne.updateRoot);ir=Qs.to({},{duration:0});var dv=function(t,e){for(var n=t._pt;n&&n.p!==e&&n.op!==e&&n.fp!==e;)n=n._next;return n},pv=function(t,e){var n=t._targets,i,s,a;for(i in e)for(s=n.length;s--;)a=t._ptLookup[s][i],a&&(a=a.d)&&(a._pt&&(a=dv(a,i)),a&&a.modifier&&a.modifier(e[i],t,n[s],i))},Ka=function(t,e){return{name:t,headless:1,rawVars:1,init:function(i,s,a){a._onInit=function(o){var l,c;if(Ee(s)&&(l={},He(s,function(u){return l[u]=1}),s=l),e){l={};for(c in s)l[c]=e(s[c]);s=l}pv(o,s)}}}},Xe=Qs.registerPlugin({name:"attr",init:function(t,e,n,i,s){var a,o,l;this.tween=n;for(a in e)l=t.getAttribute(a)||"",o=this.add(t,"setAttribute",(l||0)+"",e[a],i,s,0,0,a),o.op=a,o.b=l,this._props.push(a)},render:function(t,e){for(var n=e._pt;n;)be?n.set(n.t,n.p,n.b,n):n.r(t,n.d),n=n._next}},{name:"endArray",headless:1,init:function(t,e){for(var n=e.length;n--;)this.add(t,n,t[n]||0,e[n],0,0,0,0,0,1)}},Ka("roundProps",Zo),Ka("modifiers"),Ka("snap",fh))||Qs;ge.version=Ne.version=Xe.version="3.13.0";ju=1;Ml()&&vr();Ht.Power0;Ht.Power1;Ht.Power2;Ht.Power3;Ht.Power4;Ht.Linear;Ht.Quad;Ht.Cubic;Ht.Quart;Ht.Quint;Ht.Strong;Ht.Elastic;Ht.Back;Ht.SteppedEase;Ht.Bounce;Ht.Sine;Ht.Expo;Ht.Circ;/*!
 * CSSPlugin 3.13.0
 * https://gsap.com
 *
 ...
 * Subject to the terms at https://gsap.com/standard-license
 * @author: Jack Doyle, jack@greensock.com
*/var Jc,ni,or,Ll,Ci,Qc,Ul,mv=function(){return typeof window<"u"},Yn={},Ti=180/Math.PI,lr=Math.PI/180,Qi=Math.atan2,tu=1e8,Il=/([A-Z])/g,_v=/(left|right|width|margin|padding|x)/i,gv=/[\s,\(]\S/,wn={autoAlpha:"opacity,visibility",scale:"scaleX,scaleY",alpha:"opacity"},Qo=function(t,e){return e.set(e.t,e.p,Math.round((e.s+e.c*t)*1e4)/1e4+e.u,e)},vv=function(t,e){return e.set(e.t,e.p,t===1?e.e:Math.round((e.s+e.c*t)*1e4)/1e4+e.u,e)},xv=function(t,e){return e.set(e.t,e.p,t?Math.round((e.s+e.c*t)*1e4)/1e4+e.u:e.b,e)},Mv=function(t,e){var n=e.s+e.c*t;e.set(e.t,e.p,~~(n+(n<0?-.5:.5))+e.u,e)},Uh=function(t,e){return e.set(e.t,e.p,t?e.e:e.b,e)},Ih=function(t,e){return e.set(e.t,e.p,t!==1?e.b:e.e,e)},Sv=function(t,e,n){return t.style[e]=n},yv=function(t,e,n){return t.style.setProperty(e,n)},Ev=function(t,e,n){return t._gsap[e]=n},Tv=function(t,e,n){return t._gsap.scaleX=t._gsap.scaleY=n},bv=function(t,e,n,i,s){var a=t._gsap;a.scaleX=a.scaleY=n,a.renderTransform(s,a)},Av=function(t,e,n,i,s){var a=t._gsap;a[e]=n,a.renderTransform(s,a)},he="transform",We=he+"Origin",wv=function r(t,e){var n=this,i=this.target,s=i.style,a=i._gsap;if(t in Yn&&s){if(this.tfm=this.tfm||{},t!=="transform")t=wn[t]||t,~t.indexOf(",")?t.split(",").forEach(function(o){return n.tfm[o]=kn(i,o)}):this.tfm[t]=a.x?a[t]:kn(i,t),t===We&&(this.tfm.zOrigin=a.zOrigin);else return wn.transform.split(",").forEach(function(o){return r.call(n,o,e)});if(this.props.indexOf(he)>=0)return;a.svg&&(this.svgo=i.getAttribute("data-svg-origin"),this.props.push(We,e,"")),t=he}(s||e)&&this.props.push(t,e,s[t])},Fh=function(t){t.translate&&(t.removeProperty("translate"),t.removeProperty("scale"),t.removeProperty("rotate"))},Rv=function(){var t=this.props,e=this.target,n=e.style,i=e._gsap,s,a;for(s=0;s<t.length;s+=3)t[s+1]?t[s+1]===2?e[t[s]](t[s+2]):e[t[s]]=t[s+2]:t[s+2]?n[t[s]]=t[s+2]:n.removeProperty(t[s].substr(0,2)==="--"?t[s]:t[s].replace(Il,"-$1").toLowerCase());if(this.tfm){for(a in this.tfm)i[a]=this.tfm[a];i.svg&&(i.renderTransform(),e.setAttribute("data-svg-origin",this.svgo||"")),s=Ul(),(!s||!s.isStart)&&!n[he]&&(Fh(n),i.zOrigin&&n[We]&&(n[We]+=" "+i.zOrigin+"px",i.zOrigin=0,i.renderTransform()),i.uncache=1)}},Nh=function(t,e){var n={target:t,props:[],revert:Rv,save:wv};return t._gsap||Xe.core.getCache(t),e&&t.style&&t.nodeType&&e.split(",").forEach(function(i){return n.save(i)}),n},Oh,tl=function(t,e){var n=ni.createElementNS?ni.createElementNS((e||"http://www.w3.org/1999/xhtml").replace(/^https/,"http"),t):ni.createElement(t);return n&&n.style?n:ni.createElement(t)},fn=function r(t,e,n){var i=getComputedStyle(t);return i[e]||i.getPropertyValue(e.replace(Il,"-$1").toLowerCase())||i.getPropertyValue(e)||!n&&r(t,xr(e)||e,1)||""},eu="O,Moz,ms,Ms,Webkit".split(","),xr=function(t,e,n){var i=e||Ci,s=i.style,a=5;if(t in s&&!n)return t;for(t=t.charAt(0).toUpperCase()+t.substr(1);a--&&!(eu[a]+t in s););return a<0?null:(a===3?"ms":a>=0?eu[a]:"")+t},el=function(){mv()&&window.document&&(Jc=window,ni=Jc.document,or=ni.documentElement,Ci=tl("div")||{style:{}},tl("div"),he=xr(he),We=he+"Origin",Ci.style.cssText="border-width:0;line-height:0;position:absolute;padding:0",Oh=!!xr("perspective"),Ul=Xe.core.reverting,Ll=1)},nu=function(t){var e=t.ownerSVGElement,n=tl("svg",e&&e.getAttribute("xmlns")||"http://www.w3.org/2000/svg"),i=t.cloneNode(!0),s;i.style.display="block",n.appendChild(i),or.appendChild(n);try{s=i.getBBox()}catch{}return n.removeChild(i),or.removeChild(n),s},iu=function(t,e){for(var n=e.length;n--;)if(t.hasAttribute(e[n]))return t.getAttribute(e[n])},Bh=function(t){var e,n;try{e=t.getBBox()}catch{e=nu(t),n=1}return e&&(e.width||e.height)||n||(e=nu(t)),e&&!e.width&&!e.x&&!e.y?{x:+iu(t,["x","cx","x1"])||0,y:+iu(t,["y","cy","y1"])||0,width:0,height:0}:e},zh=function(t){return!!(t.getCTM&&(!t.parentNode||t.ownerSVGElement)&&Bh(t))},Fi=function(t,e){if(e){var n=t.style,i;e in Yn&&e!==We&&(e=he),n.removeProperty?(i=e.substr(0,2),(i==="ms"||e.substr(0,6)==="webkit")&&(e="-"+e),n.removeProperty(i==="--"?e:e.replace(Il,"-$1").toLowerCase())):n.removeAttribute(e)}},ii=function(t,e,n,i,s,a){var o=new Ge(t._pt,e,n,0,1,a?Ih:Uh);return t._pt=o,o.b=i,o.e=s,t._props.push(n),o},ru={deg:1,rad:1,turn:1},Cv={grid:1,flex:1},ci=function r(t,e,n,i){var s=parseFloat(n)||0,a=(n+"").trim().substr((s+"").length)||"px",o=Ci.style,l=_v.test(e),c=t.tagName.toLowerCase()==="svg",u=(c?"client":"offset")+(l?"Width":"Height"),h=100,f=i==="px",p=i==="%",g,_,m,d;if(i===a||!s||ru[i]||ru[a])return s;if(a!=="px"&&!f&&(s=r(t,e,n,"px")),d=t.getCTM&&zh(t),(p||a==="%")&&(Yn[e]||~e.indexOf("adius")))return g=d?t.getBBox()[l?"width":"height"]:t[u],me(p?s/g*h:s/100*g);if(o[l?"width":"height"]=h+(f?a:i),_=i!=="rem"&&~e.indexOf("adius")||i==="em"&&t.appendChild&&!c?t:t.parentNode,d&&(_=(t.ownerSVGElement||{}).parentNode),(!_||_===ni||!_.appendChild)&&(_=ni.body),m=_._gsap,m&&p&&m.width&&l&&m.time===Je.time&&!m.uncache)return me(s/m.width*h);if(p&&(e==="height"||e==="width")){var T=t.style[e];t.style[e]=h+i,g=t[u],T?t.style[e]=T:Fi(t,e)}else(p||a==="%")&&!Cv[fn(_,"display")]&&(o.position=fn(t,"position")),_===t&&(o.position="static"),_.appendChild(Ci),g=Ci[u],_.removeChild(Ci),o.position="absolute";return l&&p&&(m=Pi(_),m.time=Je.time,m.width=_[u]),me(f?g*s/h:g&&s?h/g*s:0)},kn=function(t,e,n,i){var s;return Ll||el(),e in wn&&e!=="transform"&&(e=wn[e],~e.indexOf(",")&&(e=e.split(",")[0])),Yn[e]&&e!=="transform"?(s=Jr(t,i),s=e!=="transformOrigin"?s[e]:s.svg?s.origin:ea(fn(t,We))+" "+s.zOrigin+"px"):(s=t.style[e],(!s||s==="auto"||i||~(s+"").indexOf("calc("))&&(s=ta[e]&&ta[e](t,e,n)||fn(t,e)||eh(t,e)||(e==="opacity"?1:0))),n&&!~(s+"").trim().indexOf(" ")?ci(t,e,s,n)+n:s},Pv=function(t,e,n,i){if(!n||n==="none"){var s=xr(e,t,1),a=s&&fn(t,s,1);a&&a!==n?(e=s,n=a):e==="borderColor"&&(n=fn(t,"borderTopColor"))}var o=new Ge(this._pt,t.style,e,0,1,Ph),l=0,c=0,u,h,f,p,g,_,m,d,T,E,M,b;if(o.b=n,o.e=i,n+="",i+="",i.substring(0,6)==="var(--"&&(i=fn(t,i.substring(4,i.indexOf(")")))),i==="auto"&&(_=t.style[e],t.style[e]=i,i=fn(t,e)||i,_?t.style[e]=_:Fi(t,e)),u=[n,i],Mh(u),n=u[0],i=u[1],f=n.match(nr)||[],b=i.match(nr)||[],b.length){for(;h=nr.exec(i);)m=h[0],T=i.substring(l,h.index),g?g=(g+1)%5:(T.substr(-5)==="rgba("||T.substr(-5)==="hsla(")&&(g=1),m!==(_=f[c++]||"")&&(p=parseFloat(_)||0,M=_.substr((p+"").length),m.charAt(1)==="="&&(m=ar(p,m)+M),d=parseFloat(m),E=m.substr((d+"").length),l=nr.lastIndex-E.length,E||(E=E||tn.units[e]||M,l===i.length&&(i+=E,o.e+=E)),M!==E&&(p=ci(t,e,_,E)||0),o._pt={_next:o._pt,p:T||c===1?T:",",s:p,c:d-p,m:g&&g<4||e==="zIndex"?Math.round:0});o.c=l<i.length?i.substring(l,i.length):""}else o.r=e==="display"&&i==="none"?Ih:Uh;return $u.test(i)&&(o.e=0),this._pt=o,o},su={top:"0%",bottom:"100%",left:"0%",right:"100%",center:"50%"},Dv=function(t){var e=t.split(" "),n=e[0],i=e[1]||"50%";return(n==="top"||n==="bottom"||i==="left"||i==="right")&&(t=n,n=i,i=t),e[0]=su[n]||n,e[1]=su[i]||i,e.join(" ")},Lv=function(t,e){if(e.tween&&e.tween._time===e.tween._dur){var n=e.t,i=n.style,s=e.u,a=n._gsap,o,l,c;if(s==="all"||s===!0)i.cssText="",l=1;else for(s=s.split(","),c=s.length;--c>-1;)o=s[c],Yn[o]&&(l=1,o=o==="transformOrigin"?We:he),Fi(n,o);l&&(Fi(n,he),a&&(a.svg&&n.removeAttribute("transform"),i.scale=i.rotate=i.translate="none",Jr(n,1),a.uncache=1,Fh(i)))}},ta={clearProps:function(t,e,n,i,s){if(s.data!=="isFromStart"){var a=t._pt=new Ge(t._pt,e,n,0,0,Lv);return a.u=i,a.pr=-10,a.tween=s,t._props.push(n),1}}},jr=[1,0,0,1,0,0],kh={},Vh=function(t){return t==="matrix(1, 0, 0, 1, 0, 0)"||t==="none"||!t},au=function(t){var e=fn(t,he);return Vh(e)?jr:e.substr(7).match(Ku).map(me)},Fl=function(t,e){var n=t._gsap||Pi(t),i=t.style,s=au(t),a,o,l,c;return n.svg&&t.getAttribute("transform")?(l=t.transform.baseVal.consolidate().matrix,s=[l.a,l.b,l.c,l.d,l.e,l.f],s.join(",")==="1,0,0,1,0,0"?jr:s):(s===jr&&!t.offsetParent&&t!==or&&!n.svg&&(l=i.display,i.display="block",a=t.parentNode,(!a||!t.offsetParent&&!t.getBoundingClientRect().width)&&(c=1,o=t.nextElementSibling,or.appendChild(t)),s=au(t),l?i.display=l:Fi(t,"display"),c&&(o?a.insertBefore(t,o):a?a.appendChild(t):or.removeChild(t))),e&&s.length>6?[s[0],s[1],s[4],s[5],s[12],s[13]]:s)},nl=function(t,e,n,i,s,a){var o=t._gsap,l=s||Fl(t,!0),c=o.xOrigin||0,u=o.yOrigin||0,h=o.xOffset||0,f=o.yOffset||0,p=l[0],g=l[1],_=l[2],m=l[3],d=l[4],T=l[5],E=e.split(" "),M=parseFloat(E[0])||0,b=parseFloat(E[1])||0,A,w,C,x;n?l!==jr&&(w=p*m-g*_)&&(C=M*(m/w)+b*(-_/w)+(_*T-m*d)/w,x=M*(-g/w)+b*(p/w)-(p*T-g*d)/w,M=C,b=x):(A=Bh(t),M=A.x+(~E[0].indexOf("%")?M/100*A.width:M),b=A.y+(~(E[1]||E[0]).indexOf("%")?b/100*A.height:b)),i||i!==!1&&o.smooth?(d=M-c,T=b-u,o.xOffset=h+(d*p+T*_)-d,o.yOffset=f+(d*g+T*m)-T):o.xOffset=o.yOffset=0,o.xOrigin=M,o.yOrigin=b,o.smooth=!!i,o.origin=e,o.originIsAbsolute=!!n,t.style[We]="0px 0px",a&&(ii(a,o,"xOrigin",c,M),ii(a,o,"yOrigin",u,b),ii(a,o,"xOffset",h,o.xOffset),ii(a,o,"yOffset",f,o.yOffset)),t.setAttribute("data-svg-origin",M+" "+b)},Jr=function(t,e){var n=t._gsap||new Th(t);if("x"in n&&!e&&!n.uncache)return n;var i=t.style,s=n.scaleX<0,a="px",o="deg",l=getComputedStyle(t),c=fn(t,We)||"0",u,h,f,p,g,_,m,d,T,E,M,b,A,w,C,x,y,D,N,B,X,H,G,Y,k,it,ot,pt,Ct,Kt,Gt,zt;return u=h=f=_=m=d=T=E=M=0,p=g=1,n.svg=!!(t.getCTM&&zh(t)),l.translate&&((l.translate!=="none"||l.scale!=="none"||l.rotate!=="none")&&(i[he]=(l.translate!=="none"?"translate3d("+(l.translate+" 0 0").split(" ").slice(0,3).join(", ")+") ":"")+(l.rotate!=="none"?"rotate("+l.rotate+") ":"")+(l.scale!=="none"?"scale("+l.scale.split(" ").join(",")+") ":"")+(l[he]!=="none"?l[he]:"")),i.scale=i.rotate=i.translate="none"),w=Fl(t,n.svg),n.svg&&(n.uncache?(k=t.getBBox(),c=n.xOrigin-k.x+"px "+(n.yOrigin-k.y)+"px",Y=""):Y=!e&&t.getAttribute("data-svg-origin"),nl(t,Y||c,!!Y||n.originIsAbsolute,n.smooth!==!1,w)),b=n.xOrigin||0,A=n.yOrigin||0,w!==jr&&(D=w[0],N=w[1],B=w[2],X=w[3],u=H=w[4],h=G=w[5],w.length===6?(p=Math.sqrt(D*D+N*N),g=Math.sqrt(X*X+B*B),_=D||N?Qi(N,D)*Ti:0,T=B||X?Qi(B,X)*Ti+_:0,T&&(g*=Math.abs(Math.cos(T*lr))),n.svg&&(u-=b-(b*D+A*B),h-=A-(b*N+A*X))):(zt=w[6],Kt=w[7],ot=w[8],pt=w[9],Ct=w[10],Gt=w[11],u=w[12],h=w[13],f=w[14],C=Qi(zt,Ct),m=C*Ti,C&&(x=Math.cos(-C),y=Math.sin(-C),Y=H*x+ot*y,k=G*x+pt*y,it=zt*x+Ct*y,ot=H*-y+ot*x,pt=G*-y+pt*x,Ct=zt*-y+Ct*x,Gt=Kt*-y+Gt*x,H=Y,G=k,zt=it),C=Qi(-B,Ct),d=C*Ti,C&&(x=Math.cos(-C),y=Math.sin(-C),Y=D*x-ot*y,k=N*x-pt*y,it=B*x-Ct*y,Gt=X*y+Gt*x,D=Y,N=k,B=it),C=Qi(N,D),_=C*Ti,C&&(x=Math.cos(C),y=Math.sin(C),Y=D*x+N*y,k=H*x+G*y,N=N*x-D*y,G=G*x-H*y,D=Y,H=k),m&&Math.abs(m)+Math.abs(_)>359.9&&(m=_=0,d=180-d),p=me(Math.sqrt(D*D+N*N+B*B)),g=me(Math.sqrt(G*G+zt*zt)),C=Qi(H,G),T=Math.abs(C)>2e-4?C*Ti:0,M=Gt?1/(Gt<0?-Gt:Gt):0),n.svg&&(Y=t.getAttribute("transform"),n.forceCSS=t.setAttribute("transform","")||!Vh(fn(t,he)),Y&&t.setAttribute("transform",Y))),Math.abs(T)>90&&Math.abs(T)<270&&(s?(p*=-1,T+=_<=0?180:-180,_+=_<=0?180:-180):(g*=-1,T+=T<=0?180:-180)),e=e||n.uncache,n.x=u-((n.xPercent=u&&(!e&&n.xPercent||(Math.round(t.offsetWidth/2)===Math.round(-u)?-50:0)))?t.offsetWidth*n.xPercent/100:0)+a,n.y=h-((n.yPercent=h&&(!e&&n.yPercent||(Math.round(t.offsetHeight/2)===Math.round(-h)?-50:0)))?t.offsetHeight*n.yPercent/100:0)+a,n.z=f+a,n.scaleX=me(p),n.scaleY=me(g),n.rotation=me(_)+o,n.rotationX=me(m)+o,n.rotationY=me(d)+o,n.skewX=T+o,n.skewY=E+o,n.transformPerspective=M+a,(n.zOrigin=parseFloat(c.split(" ")[2])||!e&&n.zOrigin||0)&&(i[We]=ea(c)),n.xOffset=n.yOffset=0,n.force3D=tn.force3D,n.renderTransform=n.svg?Iv:Oh?Hh:Uv,n.uncache=0,n},ea=function(t){return(t=t.split(" "))[0]+" "+t[1]},$a=function(t,e,n){var i=Ce(e);return me(parseFloat(e)+parseFloat(ci(t,"x",n+"px",i)))+i},Uv=function(t,e){e.z="0px",e.rotationY=e.rotationX="0deg",e.force3D=0,Hh(t,e)},Mi="0deg",Dr="0px",Si=") ",Hh=function(t,e){var n=e||this,i=n.xPercent,s=n.yPercent,a=n.x,o=n.y,l=n.z,c=n.rotation,u=n.rotationY,h=n.rotationX,f=n.skewX,p=n.skewY,g=n.scaleX,_=n.scaleY,m=n.transformPerspective,d=n.force3D,T=n.target,E=n.zOrigin,M="",b=d==="auto"&&t&&t!==1||d===!0;if(E&&(h!==Mi||u!==Mi)){var A=parseFloat(u)*lr,w=Math.sin(A),C=Math.cos(A),x;A=parseFloat(h)*lr,x=Math.cos(A),a=$a(T,a,w*x*-E),o=$a(T,o,-Math.sin(A)*-E),l=$a(T,l,C*x*-E+E)}m!==Dr&&(M+="perspective("+m+Si),(i||s)&&(M+="translate("+i+"%, "+s+"%) "),(b||a!==Dr||o!==Dr||l!==Dr)&&(M+=l!==Dr||b?"translate3d("+a+", "+o+", "+l+") ":"translate("+a+", "+o+Si),c!==Mi&&(M+="rotate("+c+Si),u!==Mi&&(M+="rotateY("+u+Si),h!==Mi&&(M+="rotateX("+h+Si),(f!==Mi||p!==Mi)&&(M+="skew("+f+", "+p+Si),(g!==1||_!==1)&&(M+="scale("+g+", "+_+Si),T.style[he]=M||"translate(0, 0)"},Iv=function(t,e){var n=e||this,i=n.xPercent,s=n.yPercent,a=n.x,o=n.y,l=n.rotation,c=n.skewX,u=n.skewY,h=n.scaleX,f=n.scaleY,p=n.target,g=n.xOrigin,_=n.yOrigin,m=n.xOffset,d=n.yOffset,T=n.forceCSS,E=parseFloat(a),M=parseFloat(o),b,A,w,C,x;l=parseFloat(l),c=parseFloat(c),u=parseFloat(u),u&&(u=parseFloat(u),c+=u,l+=u),l||c?(l*=lr,c*=lr,b=Math.cos(l)*h,A=Math.sin(l)*h,w=Math.sin(l-c)*-f,C=Math.cos(l-c)*f,c&&(u*=lr,x=Math.tan(c-u),x=Math.sqrt(1+x*x),w*=x,C*=x,u&&(x=Math.tan(u),x=Math.sqrt(1+x*x),b*=x,A*=x)),b=me(b),A=me(A),w=me(w),C=me(C)):(b=h,C=f,A=w=0),(E&&!~(a+"").indexOf("px")||M&&!~(o+"").indexOf("px"))&&(E=ci(p,"x",a,"px"),M=ci(p,"y",o,"px")),(g||_||m||d)&&(E=me(E+g-(g*b+_*w)+m),M=me(M+_-(g*A+_*C)+d)),(i||s)&&(x=p.getBBox(),E=me(E+i/100*x.width),M=me(M+s/100*x.height)),x="matrix("+b+","+A+","+w+","+C+","+E+","+M+")",p.setAttribute("transform",x),T&&(p.style[he]=x)},Fv=function(t,e,n,i,s){var a=360,o=Ee(s),l=parseFloat(s)*(o&&~s.indexOf("rad")?Ti:1),c=l-i,u=i+c+"deg",h,f;return o&&(h=s.split("_")[1],h==="short"&&(c%=a,c!==c%(a/2)&&(c+=c<0?a:-a)),h==="cw"&&c<0?c=(c+a*tu)%a-~~(c/a)*a:h==="ccw"&&c>0&&(c=(c-a*tu)%a-~~(c/a)*a)),t._pt=f=new Ge(t._pt,e,n,i,c,vv),f.e=u,f.u="deg",t._props.push(n),f},ou=function(t,e){for(var n in e)t[n]=e[n];return t},Nv=function(t,e,n){var i=ou({},n._gsap),s="perspective,force3D,transformOrigin,svgOrigin",a=n.style,o,l,c,u,h,f,p,g;i.svg?(c=n.getAttribute("transform"),n.setAttribute("transform",""),a[he]=e,o=Jr(n,1),Fi(n,he),n.setAttribute("transform",c)):(c=getComputedStyle(n)[he],a[he]=e,o=Jr(n,1),a[he]=c);for(l in Yn)c=i[l],u=o[l],c!==u&&s.indexOf(l)<0&&(p=Ce(c),g=Ce(u),h=p!==g?ci(n,l,c,g):parseFloat(c),f=parseFloat(u),t._pt=new Ge(t._pt,o,l,h,f-h,Qo),t._pt.u=g||0,t._props.push(l));ou(o,i)};He("padding,margin,Width,Radius",function(r,t){var e="Top",n="Right",i="Bottom",s="Left",a=(t<3?[e,n,i,s]:[e+s,e+n,i+n,i+s]).map(function(o){return t<2?r+o:"border"+o+r});ta[t>1?"border"+r:r]=function(o,l,c,u,h){var f,p;if(arguments.length<4)return f=a.map(function(g){return kn(o,g,c)}),p=f.join(" "),p.split(f[0]).length===5?f[0]:p;f=(u+"").split(" "),p={},a.forEach(function(g,_){return p[g]=f[_]=f[_]||f[(_-1)/2|0]}),o.init(l,p,h)}});var Gh={name:"css",register:el,targetTest:function(t){return t.style&&t.nodeType},init:function(t,e,n,i,s){var a=this._props,o=t.style,l=n.vars.startAt,c,u,h,f,p,g,_,m,d,T,E,M,b,A,w,C;Ll||el(),this.styles=this.styles||Nh(t),C=this.styles.props,this.tween=n;for(_ in e)if(_!=="autoRound"&&(u=e[_],!(Ze[_]&&bh(_,e,n,i,t,s)))){if(p=typeof u,g=ta[_],p==="function"&&(u=u.call(n,i,t,s),p=typeof u),p==="string"&&~u.indexOf("random(")&&(u=Kr(u)),g)g(this,t,_,u,n)&&(w=1);else if(_.substr(0,2)==="--")c=(getComputedStyle(t).getPropertyValue(_)+"").trim(),u+="",ai.lastIndex=0,ai.test(c)||(m=Ce(c),d=Ce(u)),d?m!==d&&(c=ci(t,_,c,d)+d):m&&(u+=m),this.add(o,"setProperty",c,u,i,s,0,0,_),a.push(_),C.push(_,0,o[_]);else if(p!=="undefined"){if(l&&_ in l?(c=typeof l[_]=="function"?l[_].call(n,i,t,s):l[_],Ee(c)&&~c.indexOf("random(")&&(c=Kr(c)),Ce(c+"")||c==="auto"||(c+=tn.units[_]||Ce(kn(t,_))||""),(c+"").charAt(1)==="="&&(c=kn(t,_))):c=kn(t,_),f=parseFloat(c),T=p==="string"&&u.charAt(1)==="="&&u.substr(0,2),T&&(u=u.substr(2)),h=parseFloat(u),_ in wn&&(_==="autoAlpha"&&(f===1&&kn(t,"visibility")==="hidden"&&h&&(f=0),C.push("visibility",0,o.visibility),ii(this,o,"visibility",f?"inherit":"hidden",h?"inherit":"hidden",!h)),_!=="scale"&&_!=="transform"&&(_=wn[_],~_.indexOf(",")&&(_=_.split(",")[0]))),E=_ in Yn,E){if(this.styles.save(_),p==="string"&&u.substring(0,6)==="var(--"&&(u=fn(t,u.substring(4,u.indexOf(")"))),h=parseFloat(u)),M||(b=t._gsap,b.renderTransform&&!e.parseTransform||Jr(t,e.parseTransform),A=e.smoothOrigin!==!1&&b.smooth,M=this._pt=new Ge(this._pt,o,he,0,1,b.renderTransform,b,0,-1),M.dep=1),_==="scale")this._pt=new Ge(this._pt,b,"scaleY",b.scaleY,(T?ar(b.scaleY,T+h):h)-b.scaleY||0,Qo),this._pt.u=0,a.push("scaleY",_),_+="X";else if(_==="transformOrigin"){C.push(We,0,o[We]),u=Dv(u),b.svg?nl(t,u,0,A,0,this):(d=parseFloat(u.split(" ")[2])||0,d!==b.zOrigin&&ii(this,b,"zOrigin",b.zOrigin,d),ii(this,o,_,ea(c),ea(u)));continue}else if(_==="svgOrigin"){nl(t,u,1,A,0,this);continue}else if(_ in kh){Fv(this,b,_,f,T?ar(f,T+u):u);continue}else if(_==="smoothOrigin"){ii(this,b,"smooth",b.smooth,u);continue}else if(_==="force3D"){b[_]=u;continue}else if(_==="transform"){Nv(this,u,t);continue}}else _ in o||(_=xr(_)||_);if(E||(h||h===0)&&(f||f===0)&&!gv.test(u)&&_ in o)m=(c+"").substr((f+"").length),h||(h=0),d=Ce(u)||(_ in tn.units?tn.units[_]:m),m!==d&&(f=ci(t,_,c,d)),this._pt=new Ge(this._pt,E?b:o,_,f,(T?ar(f,T+h):h)-f,!E&&(d==="px"||_==="zIndex")&&e.autoRound!==!1?Mv:Qo),this._pt.u=d||0,m!==d&&d!=="%"&&(this._pt.b=c,this._pt.r=xv);else if(_ in o)Pv.call(this,t,_,c,T?T+u:u);else if(_ in t)this.add(t,_,c||t[_],T?T+u:u,i,s);else if(_!=="parseTransform"){yl(_,u);continue}E||(_ in o?C.push(_,0,o[_]):typeof t[_]=="function"?C.push(_,2,t[_]()):C.push(_,1,c||t[_])),a.push(_)}}w&&Dh(this)},render:function(t,e){if(e.tween._time||!Ul())for(var n=e._pt;n;)n.r(t,n.d),n=n._next;else e.styles.revert()},get:kn,aliases:wn,getSetter:function(t,e,n){var i=wn[e];return i&&i.indexOf(",")<0&&(e=i),e in Yn&&e!==We&&(t._gsap.x||kn(t,"x"))?n&&Qc===n?e==="scale"?Tv:Ev:(Qc=n||{})&&(e==="scale"?bv:Av):t.style&&!xl(t.style[e])?Sv:~e.indexOf("-")?yv:Pl(t,e)},core:{_removeProperty:Fi,_getMatrix:Fl}};Xe.utils.checkPrefix=xr;Xe.core.getStyleSaver=Nh;(function(r,t,e,n){var i=He(r+","+t+","+e,function(s){Yn[s]=1});He(t,function(s){tn.units[s]="deg",kh[s]=1}),wn[i[13]]=r+","+t,He(n,function(s){var a=s.split(":");wn[a[1]]=i[a[0]]})})("x,y,z,scale,scaleX,scaleY,xPercent,yPercent","rotation,rotationX,rotationY,skewX,skewY","transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective","0:translateX,1:translateY,2:translateZ,8:rotate,8:rotationZ,8:rotateZ,9:rotateX,10:rotateY");He("x,y,z,top,right,bottom,left,width,height,fontSize,padding,margin,perspective",function(r){tn.units[r]="px"});Xe.registerPlugin(Gh);var Te=Xe.registerPlugin(Gh)||Xe;Te.core.Tween;const Hs={name:"CopyShader",uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		}`};class rs{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error("THREE.Pass: .render() must be implemented in derived pass.")}dispose(){}}const Ov=new Bu(-1,1,1,-1,0,1);class Bv extends en{constructor(){super(),this.setAttribute("position",new Oe([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute("uv",new Oe([0,2,0,0,2,0],2))}}const zv=new Bv;class Wh{constructor(t){this._mesh=new vn(zv,t)}dispose(){this._mesh.geometry.dispose()}render(t){t.render(this._mesh,Ov)}get material(){return this._mesh.material}set material(t){this._mesh.material=t}}class kv extends rs{constructor(t,e="tDiffuse"){super(),this.textureID=e,this.uniforms=null,this.material=null,t instanceof Pe?(this.uniforms=t.uniforms,this.material=t):t&&(this.uniforms=qs.clone(t.uniforms),this.material=new Pe({name:t.name!==void 0?t.name:"unspecified",defines:Object.assign({},t.defines),uniforms:this.uniforms,vertexShader:t.vertexShader,fragmentShader:t.fragmentShader})),this._fsQuad=new Wh(this.material)}render(t,e,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(t.setRenderTarget(null),this._fsQuad.render(t)):(t.setRenderTarget(e),this.clear&&t.clear(t.autoClearColor,t.autoClearDepth,t.autoClearStencil),this._fsQuad.render(t))}dispose(){this.material.dispose(),this._fsQuad.dispose()}}class lu extends rs{constructor(t,e){super(),this.scene=t,this.camera=e,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(t,e,n){const i=t.getContext(),s=t.state;s.buffers.color.setMask(!1),s.buffers.depth.setMask(!1),s.buffers.color.setLocked(!0),s.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),s.buffers.stencil.setTest(!0),s.buffers.stencil.setOp(i.REPLACE,i.REPLACE,i.REPLACE),s.buffers.stencil.setFunc(i.ALWAYS,a,4294967295),s.buffers.stencil.setClear(o),s.buffers.stencil.setLocked(!0),t.setRenderTarget(n),this.clear&&t.clear(),t.render(this.scene,this.camera),t.setRenderTarget(e),this.clear&&t.clear(),t.render(this.scene,this.camera),s.buffers.color.setLocked(!1),s.buffers.depth.setLocked(!1),s.buffers.color.setMask(!0),s.buffers.depth.setMask(!0),s.buffers.stencil.setLocked(!1),s.buffers.stencil.setFunc(i.EQUAL,1,4294967295),s.buffers.stencil.setOp(i.KEEP,i.KEEP,i.KEEP),s.buffers.stencil.setLocked(!0)}}class Vv extends rs{constructor(){super(),this.needsSwap=!1}render(t){t.state.buffers.stencil.setLocked(!1),t.state.buffers.stencil.setTest(!1)}}class Hv{constructor(t,e){if(this.renderer=t,this._pixelRatio=t.getPixelRatio(),e===void 0){const n=t.getSize(new Lt);this._width=n.width,this._height=n.height,e=new Mn(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:Wn}),e.texture.name="EffectComposer.rt1"}else this._width=e.width,this._height=e.height;this.renderTarget1=e,this.renderTarget2=e.clone(),this.renderTarget2.texture.name="EffectComposer.rt2",this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new kv(Hs),this.copyPass.material.blending=Gn,this.clock=new zu}swapBuffers(){const t=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=t}addPass(t){this.passes.push(t),t.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(t,e){this.passes.splice(e,0,t),t.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(t){const e=this.passes.indexOf(t);e!==-1&&this.passes.splice(e,1)}isLastEnabledPass(t){for(let e=t+1;e<this.passes.length;e++)if(this.passes[e].enabled)return!1;return!0}render(t){t===void 0&&(t=this.clock.getDelta());const e=this.renderer.getRenderTarget();let n=!1;for(let i=0,s=this.passes.length;i<s;i++){const a=this.passes[i];if(a.enabled!==!1){if(a.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(i),a.render(this.renderer,this.writeBuffer,this.readBuffer,t,n),a.needsSwap){if(n){const o=this.renderer.getContext(),l=this.renderer.state.buffers.stencil;l.setFunc(o.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,t),l.setFunc(o.EQUAL,1,4294967295)}this.swapBuffers()}lu!==void 0&&(a instanceof lu?n=!0:a instanceof Vv&&(n=!1))}}this.renderer.setRenderTarget(e)}reset(t){if(t===void 0){const e=this.renderer.getSize(new Lt);this._pixelRatio=this.renderer.getPixelRatio(),this._width=e.width,this._height=e.height,t=this.renderTarget1.clone(),t.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=t,this.renderTarget2=t.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(t,e){this._width=t,this._height=e;const n=this._width*this._pixelRatio,i=this._height*this._pixelRatio;this.renderTarget1.setSize(n,i),this.renderTarget2.setSize(n,i);for(let s=0;s<this.passes.length;s++)this.passes[s].setSize(n,i)}setPixelRatio(t){this._pixelRatio=t,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}}class Gv extends rs{constructor(t,e,n=null,i=null,s=null){super(),this.scene=t,this.camera=e,this.overrideMaterial=n,this.clearColor=i,this.clearAlpha=s,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this._oldClearColor=new It}render(t,e,n){const i=t.autoClear;t.autoClear=!1;let s,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(t.getClearColor(this._oldClearColor),t.setClearColor(this.clearColor,t.getClearAlpha())),this.clearAlpha!==null&&(s=t.getClearAlpha(),t.setClearAlpha(this.clearAlpha)),this.clearDepth==!0&&t.clearDepth(),t.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&t.clear(t.autoClearColor,t.autoClearDepth,t.autoClearStencil),t.render(this.scene,this.camera),this.clearColor!==null&&t.setClearColor(this._oldClearColor),this.clearAlpha!==null&&t.setClearAlpha(s),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),t.autoClear=i}}const Wv={uniforms:{tDiffuse:{value:null},luminosityThreshold:{value:1},smoothWidth:{value:1},defaultColor:{value:new It(0)},defaultOpacity:{value:0}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}}Mr.BlurDirectionX=new Lt(1,0);Mr.BlurDirectionY=new Lt(0,1);class Xv{constructor(t){this.container=t,this.scene=new Ad,this.camera=new je(70,window.innerWidth/window.innerHeight,.1,1e3),this.camera.position.set(0,0,85),this.camera.lookAt(0,0,0),this.renderer=new y0({antialias:!0}),this.renderer.setSize(window.innerWidth,window.innerHeight),this.renderer.setPixelRatio(window.devicePixelRatio),this.renderer.setClearColor(0,1),this.container.appendChild(this.renderer.domElement),this.composer=new Hv(this.renderer),this.composer.addPass(new Gv(this.scene,this.camera));const e=new Mr(new Lt(window.innerWidth,window.innerHeight),.8,.4,.2);this.composer.addPass(e),this.light=new Od(16777215,2,200),this.light.position.set(0,0,50),this.scene.add(this.light),this.scene.add(new Bd(2236979,.6)),this.scene.fog=new pl(16,.001),this.fogDensity={value:0},Te.to(this.fogDensity,{value:.001,duration:5,ease:"power2.out",onUpdate:()=>{this.scene.fog.density=this.fogDensity.value}}),this.createStars(),this.createPlanets(),this.activeIndex=0,this.nextIndex=1,this.travelLine=null,this.trailLine=null,this.wavePhase=0,this.spawnTravelLine(),this.globalPulse={intensity:0},Te.to(this.globalPulse,{intensity:1,duration:3,repeat:-1,yoyo:!0,ease:"sine.inOut"}),this.targetX=0,this.targetY=0,window.addEventListener("mousemove",i=>{const s=i.clientX/window.innerWidth*2-1,a=i.clientY/window.innerHeight*2-1;this.targetX=s*15,this.targetY=a*8}),this.clock=new zu,this.animate=this.animate.bind(this),requestAnimationFrame(this.animate);let n;window.addEventListener("resize",()=>{clearTimeout(n),n=setTimeout(()=>this.onWindowResize(),200)})}createStars(){const t=window.innerWidth<768?1500:4e3,e=new en,n=[];for(let s=0;s<t;s++){const a=di.randFloatSpread(800),o=di.randFloatSpread(800),l=di.randFloatSpread(800);n.push(a,o,l)}e.setAttribute("position",new Oe(n,3));const i=new Iu({color:16777215,size:.5,opacity:0,transparent:!0});this.stars=new Dd(e,i),this.scene.add(this.stars),Te.to(this.stars.material,{opacity:.65,duration:4,ease:"sine.inOut",delay:.8})}createPlanets(){const t=window.innerWidth<768?30:65;this.planets=[];const e=[12759680,14205056,7372944,4021132,4822992,13716008,10910802,5918017],n=55;for(let i=0;i<t;i++){const s=Math.random()*2*Math.PI,a=Math.acos(2*Math.random()-1),o=n+di.randFloat(-3,3),l=o*Math.sin(a)*Math.cos(s),c=o*Math.sin(a)*Math.sin(s),u=o*Math.cos(a),h=new It(e[Math.floor(Math.random()*e.length)]),f=new Ld({color:h,metalness:.3,roughness:.7,emissive:h.clone().multiplyScalar(.05),transparent:!0,opacity:0}),p=new _l(.9,32,32),g=new vn(p,f);g.position.set(l,c,u),g.scale.setScalar(Math.random()*2+.8),g.rotationSpeed=Math.random()*.005,this.scene.add(g),this.planets.push(g),Te.to(g.material,{opacity:1,duration:3+Math.random()*2,delay:Math.random()*2,ease:"sine.inOut"})}}spawnTravelLine(){this.travelLine&&(this.scene.remove(this.travelLine),this.scene.remove(this.trailLine),this.travelLine.geometry.dispose(),this.trailLine.geometry.dispose());const t=this.planets[this.activeIndex].position.clone(),e=this.planets[this.nextIndex].position.clone(),n=120,i=[];for(let l=0;l<n;l++){const c=l/(n-1),u=di.lerp(t.x,e.x,c),h=di.lerp(t.y,e.y,c),f=di.lerp(t.z,e.z,c);i.push(u,h,f)}const s=new en;s.setAttribute("position",new Oe(i,3));const a=new Pe({transparent:!0,uniforms:{uTime:{value:0},uColorA:{value:new It(3381759)},uColorB:{value:new It(16777215)},uOpacity:{value:0}},vertexShader:`
        uniform float uTime;
        varying float vPos;
        void main() {
      ...
      `}),o=new Pe({transparent:!0,uniforms:{uTime:{value:0},uColor:{value:new It(6737151)},uOpacity:{value:0}},vertexShader:`
        uniform float uTime;
        varying float vWave;
        void main() {
      ...
      `});this.travelLine=new pc(s,a),this.trailLine=new pc(s.clone(),o),this.scene.add(this.trailLine),this.scene.add(this.travelLine),Te.to(a.uniforms.uOpacity,{value:1,duration:1.5,ease:"sine.inOut"}),Te.to(o.uniforms.uOpacity,{value:.4,duration:1.5,ease:"sine.inOut"}),Te.to(a.uniforms.uOpacity,{value:0,duration:1.5,delay:3.2,ease:"sine.inOut",onComplete:()=>{this.activeIndex=this.nextIndex,this.nextIndex=(this.nextIndex+1)%this.planets.length,this.spawnTravelLine()}}),Te.to(o.uniforms.uOpacity,{value:0,duration:1.5,delay:2.8,ease:"sine.inOut"}),this.currentMaterial=a,this.currentTrailMaterial=o}updateTravelLine(t){this.travelLine&&(this.currentMaterial.uniforms.uTime.value+=t,this.currentTrailMaterial.uniforms.uTime.value+=t)}animate(){const t=this.clock.getDelta(),e=this.clock.getElapsedTime();this.scene.rotation.y+=8e-4,this.scene.rotation.x=Math.sin(e*.1)*.1,this.updateTravelLine(t);const n=this.globalPulse.intensity;this.stars.material.opacity=.55+n*.35,this.light.intensity=1.5+n*.8,this.planets.forEach((i,s)=>{i.material.emissiveIntensity=.05+n*.1+Math.sin(e*1.5+s)*.03,i.rotation.y+=i.rotationSpeed}),this.camera.position.x+=(this.targetX-this.camera.position.x)*.05,this.camera.position.y+=(this.targetY-this.camera.position.y)*.05,this.camera.lookAt(0,0,0),this.composer.render(),requestAnimationFrame(this.animate)}onWindowResize(){this.camera.aspect=window.innerWidth/window.innerHeight,this.camera.updateProjectionMatrix(),this.renderer.setSize(window.innerWidth,window.innerHeight),this.composer.setSize(window.innerWidth,window.innerHeight)}}const qv=document.getElementById("scene-container");let ce=null;try{ce=new Xv(qv)}catch(r){console.error("Ошибка инициализации SceneManager:",r)}window.addEventListener("mousemove",r=>{ce&&typeof ce.onMouseMove=="function"&&ce.onMouseMove(r)});window.addEventListener("click",r=>{ce&&typeof ce.onClick=="function"&&ce.onClick(r)});window.addEventListener("resize",()=>{ce&&typeof ce.onWindowResize=="function"&&ce.onWindowResize()});window.addEventListener("beforeunload",()=>{ce&&typeof ce.dispose=="function"&&ce.dispose()});const Za=document.querySelector(".btn-glow"),cu=document.querySelector(".logo"),uu=document.querySelector(".ui-overlay h1"),hu=document.querySelector(".ui-overlay p");Za&&Za.addEventListener("click",()=>{if(!ce)return;console.log("🚀 PulseMatrix launch initiated"),Te.fromTo(Za,{boxShadow:"0 0 10px #00ffff"},{boxShadow:"0 0 40px #00ffff, 0 0 80px #0099ff",duration:.4,yoyo:!0,repeat:1,ease:"power2.inOut"}),cu&&Te.fromTo(cu,{textShadow:"0 0 10px #00ffff, 0 0 20px #0099ff",scale:1},{textShadow:"0 0 25px #00ffff, 0 0 45px #0099ff, 0 0 70px #00ccff",scale:1.05,duration:.8,yoyo:!0,repeat:3,ease:"sine.inOut"}),uu&&hu&&Te.to([uu,hu],{opacity:1,duration:1.5,delay:.2,textShadow:"0 0 20px #00ffff, 0 0 60px #0099ff",ease:"sine.inOut"}),ce.globalPulse&&Te.to(ce.globalPulse,{intensity:2,duration:2,yoyo:!0,repeat:1,ease:"sine.inOut"});const r=ce.scene.rotation.y;Te.to(ce.scene.rotation,{y:r+Math.PI*2,duration:5,ease:"power2.out"}),ce.light&&Te.to(ce.light,{intensity:4,duration:.6,yoyo:!0,repeat:1}),ce.camera&&Te.to(ce.camera.position,{z:ce.camera.position.z-5,duration:4,ease:"power1.inOut",yoyo:!0,repeat:1})});window.addEventListener("load",()=>{Te.timeline().from(".top-bar",{y:-50,opacity:0,duration:1,ease:"power2.out"}).from(".ui-overlay h1",{opacity:0,scale:.9,duration:1.2},"-=0.4").from(".ui-overlay p",{opacity:0,y:20,duration:1},"-=0.8").from(".btn-glow",{opacity:0,y:-10,duration:.8},"-=0.6")});
